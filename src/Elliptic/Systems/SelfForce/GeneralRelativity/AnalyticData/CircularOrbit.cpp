  ...
  if (penetrating_horizon_) {
    ...
    for (size_t i = 0; i < r.size(); i++) {
      if (version_ == 2) {
        ...
        detail::getAreal_vrz_comp(m_mode_number_, a, m_mode_number_ * omega, inv_r[i],
                             cos_theta[i], H[i], dH[i], Areal_vr);
        detail::getAimag_vrz_comp(m_mode_number_, a, m_mode_number_ * omega, inv_r[i],
                             cos_theta[i], H[i], dH[i], Aimag_vr);
        detail::getBreal_vrz_comp(m_mode_number_, a, m_mode_number_ * omega, inv_r[i],
                             cos_theta[i], H[i], dH[i], Breal_vr);
        detail::getBimag_vrz_comp(m_mode_number_, a, m_mode_number_ * omega, inv_r[i],
                             cos_theta[i], H[i], dH[i], Bimag_vr);
        detail::getCreal_vrz_comp(m_mode_number_, a, m_mode_number_ * omega, inv_r[i],
                             cos_theta[i], H[i], dH[i], Creal_vr);
        detail::getCimag_vrz_comp(m_mode_number_, a, m_mode_number_ * omega, inv_r[i],
                             cos_theta[i], H[i], dH[i], Cimag_vr);
      }
