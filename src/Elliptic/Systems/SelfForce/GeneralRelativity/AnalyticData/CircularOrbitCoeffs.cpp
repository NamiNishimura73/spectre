...
Areal[7][6]=0;
Areal[7][7]=(-2*a*a*(a*a+(-2+r)*r)*(a*a*z*z+r*r*(-1+2*z*z)))/(pow(a*a+r*r,2)*(r*r*r+a*a*r*z*z));
Areal[7][8]=(4*a*a*a*z*pow(-1+z*z,2))/((a*a+r*r)*(r*r+a*a*z*z));
Areal[7][9]=0;
Areal[8][0]=0;
Areal[8][1]=0;
...
Areal[8][7]=0;
Areal[8][8]=(-2*(pow(a,8)*z*z*z*z+a*a*pow(r,5)*(3+(-5+r)*z*z)+pow(a,6)*r*z*z*(-1+r+(-1+2*r)*z*z)+a*a*a*a*r*r*r*(1+2*(-1+r)*z*z+(-3+r)*z*z*z*z)))/(r*pow(a*a+r*r,2)*pow(r*r+a*a*z*z,2));
Areal[8][9]=(2*a*a*a*z)/((a*a+r*r)*(r*r+a*a*z*z));
Areal[9][0]=0;
Areal[9][1]=0;
Areal[9][2]=0;
...
void getAreal_vrz_reduced(int /*m*/, double /*a*/, double /*om*/, double r, double /*z*/, double /*H*/, double  /*dHdr*/, std::array<std::array<double, 10>, 10>& Areal){
/* om = m*Omega for circular */
/* v slicing is the default */
Areal[0][0]=4/pow(r,2);
Areal[0][1]=0;
...
Breal[7][6]=0;
Breal[7][7]=4*z*(-(1/(a*a+r*r))+1/(r*r+a*a*z*z));
Breal[7][8]=(-4*a*r*pow(-1+z*z,2))/((a*a+r*r)*(r*r+a*a*z*z));
Breal[7][9]=0;
Breal[8][0]=0;
Breal[8][1]=0;
...
Breal[8][7]=0;
Breal[8][8]=(2*z*(2*r*r*r*r+a*a*r*(-2+r+(2+3*r)*z*z)+a*a*a*a*(z*z+z*z*z*z)))/((a*a+r*r)*pow(r*r+a*a*z*z,2));
Breal[8][9]=(-2*a*r)/((a*a+r*r)*(r*r+a*a*z*z));
Breal[9][0]=0;
Breal[9][1]=0;
Breal[9][2]=0;
...
void getBreal_vrz_reduced(int /*m*/, double /*a*/, double /*om*/, double r, double z, double /*H*/, double /*dHdr*/, std::array<std::array<double, 10>, 10>& Breal){
/* om = m*Omega */
Breal[0][0]=0;
Breal[0][1]=0;
Breal[0][2]=0;
...
Breal[5][2]=0;
Breal[5][3]=0;
Breal[5][4]=(4-2*r)/pow(r,3);
Breal[5][5]=(2*z)/pow(r,2);
Breal[5][6]=0;
Breal[5][7]=2/pow(r,2);
Breal[5][8]=0;
Breal[5][9]=0;
...
Breal[7][3]=0;
Breal[7][4]=0;
Breal[7][5]=(4*(-2+r)*(-1+pow(z,2)))/pow(r,3);
Breal[7][6]=0;
Breal[7][7]=0;
Breal[7][8]=0;
Breal[7][9]=0;
...
Creal[0][7]=(2*r*r*r*(-((-2+r)*r*r*r)+a*a*r*(-3*r+5*(-2+r)*z*z)+a*a*a*a*(9*z*z-6*z*z*z*z)))/((a*a+r*r)*pow(r*r+a*a*z*z,4));
Creal[0][8]=(-12*a*a*a*r*r*z*pow(-1+z*z,2)*(-3*r*r+a*a*z*z))/((a*a+r*r)*pow(r*r+a*a*z*z,4));
Creal[0][9]=(-2*r*r*r*((-2+r)*r*r*r+3*a*a*a*a*z*z*(3-4*z*z)+a*a*r*(-3*r+(10+r)*z*z)))/((a*a+r*r)*pow(r*r+a*a*z*z,4));
Creal[1][0]=(2*(r*r*r*r*r*r-a*a*a*a*a*a*z*z*z*z+a*a*a*a*r*z*z*(-5-2*r+(5+r)*z*z)+a*a*r*r*r*(1-r+(-1+2*r)*z*z)))/((a*a+r*r)*pow(r*r+a*a*z*z,3));
...
Creal[2][6]=(-4*a*(a*a+(-2+r)*r)*z*(-5*r*r+a*a*z*z))/((a*a+r*r)*pow(r*r+a*a*z*z,3));
Creal[2][7]=0;
Creal[2][8]=(2*(8*a*a*a*r*r*z*z*(1-2*z*z)+a*a*a*a*a*z*z*z*z*(-1+z*z)-a*r*r*r*r*(3+5*z*z)))/((a*a+r*r)*pow(r*r+a*a*z*z,3));
...
Creal[5][8]=(2*a*r*(1-5*z*z))/((a*a+r*r)*(r*r+a*a*z*z));
...
Creal[6][8]=(2*z*(-4*r*r+a*a*(-1+z*z)))/((a*a+r*r)*(r*r+a*a*z*z));
...
Creal[7][8]=(4*a*z*(-1+z*z)*(-3*r*r+a*a*(-1+z*z)))/(r*(a*a+r*r)*(r*r+a*a*z*z));
Creal[7][9]=(2*(r*r*r*(2+(-2+r)*z*z)+a*a*r*(r-(4+3*r)*z*z+4*(1+r)*z*z*z*z)+a*a*a*a*(z*z-3*z*z*z*z+3*z*z*z*z*z*z)))/((a*a+r*r)*(-1+z*z)*pow(r*r+a*a*z*z,2));
Creal[8][0]=(4*(-5*a*a*a*r*r*z+a*a*a*a*a*z*z*z))/(r*r*pow(r*r+a*a*z*z,3));
Creal[8][1]=(4*a*a*a*(a*a+(-2+r)*r)*z*(-5*r*r+a*a*z*z))/(r*r*(a*a+r*r)*pow(r*r+a*a*z*z,3));
Creal[8][2]=(4*(3*a*r*r*r*r+a*a*a*a*a*z*z*(-4+z*z)-2*a*a*a*r*r*(-1+z*z)))/((a*a+r*r)*pow(r*r+a*a*z*z,3));
Creal[8][3]=(4*a*a*z*((-5+r)*r*r*r*r+a*a*a*a*z*z*(2+(-1+r)*z*z)+2*a*a*r*r*(-5+(3+r)*z*z)))/(r*(a*a+r*r)*pow(r*r+a*a*z*z,3));
Creal[8][4]=0;
Creal[8][5]=0;
Creal[8][6]=(4*a*a*z*(r*r*r*(10+(-6+r)*r)+a*a*r*(-5*r+(-2+r*(-1+2*r))*z*z)+a*a*a*a*(z*z+(-1+r)*z*z*z*z)))/(r*(a*a+r*r)*pow(r*r+a*a*z*z,3));
Creal[8][7]=0;
Creal[8][8]=(-(a*a*om*om*(-1+z*z))+(2*(r*r*r*r*r*r*(1+2*r)+a*a*a*a*r*r*z*z*(-8+2*r+11*z*z)+a*a*a*a*a*a*z*z*z*z*(1+r-r*z*z)+a*a*r*r*r*r*(3+r+3*r*z*z)))/(r*pow(r*r+a*a*z*z,3)))/(a*a+r*r);
Creal[8][9]=(2*a*a*a*(-10+r)*r*r*r*z+4*a*a*a*a*a*r*(1+r)*z*z*z+2*pow(a,7)*z*z*z*z*z)/(r*(a*a+r*r)*pow(r*r+a*a*z*z,3));
Creal[9][0]=(-2*(pow(r,9)+a*a*r*r*r*r*r*r*(-8+r+(8+3*r)*z*z)+pow(a,8)*z*z*(9-4*z*z+(-5+r)*z*z*z*z)+a*a*a*a*r*r*r*(-2-9*r+(4+r*(16+3*r))*z*z+(-2+r*(-7+3*r))*z*z*z*z)+a*a*a*a*a*a*r*(-3*r+(10+23*r)*z*z+(1+r)*(-20+3*r)*z*z*z*z+(10+(-3+r)*r)*z*z*z*z*z*z)))/(r*(a*a+r*r)*pow(r*r+a*a*z*z,4));
Creal[9][1]=(4*(-((-3+r)*pow(r,7))-3*a*a*r*r*r*r*(1-2*r+(-1+r+r*r)*z*z)+a*a*a*a*a*a*z*z*(-9*r+(1+4*r)*z*z-pow(-1+r,2)*z*z*z*z)+a*a*a*a*r*r*(3*r+2*(5-7*r)*z*z+(-10+(8-3*r)*r)*z*z*z*z)))/(r*r*pow(r*r+a*a*z*z,4));
...
Creal[9][7]=(2*(pow(a,8)*pow(z,8)+pow(r,7)*(2+(-2+r)*z*z)+a*a*r*r*r*r*(-2+5*r+(4+(-6+r)*r)*z*z+(-2+r+3*r*r)*z*z*z*z)+a*a*a*a*a*a*r*z*z*(-9+16*z*z+(-5+3*r)*z*z*z*z+(-2+r)*z*z*z*z*z*z)+a*a*a*a*r*r*(3*r+5*(2-3*r)*z*z+(-20+r*(23+3*r))*z*z*z*z+(-2+r)*(-5+3*r)*z*z*z*z*z*z)))/((a*a+r*r)*(-1+z*z)*pow(r*r+a*a*z*z,4));
Creal[9][8]=(-4*a*z*(-1+z*z)*(pow(r,7)+a*a*r*r*r*r*(10+(-10+3*r)*z*z)+a*a*a*a*a*a*z*z*(-3+4*z*z+(-1+r)*z*z*z*z)+a*a*a*a*r*r*(9-10*z*z+(1+3*r)*z*z*z*z)))/((a*a+r*r)*pow(r*r+a*a*z*z,4));
...
void getCreal_vrz_reduced(int /*m*/, double /*a*/, double /*om*/, double r, double z, double /*H*/, double /*dHdr*/, std::array<std::array<double, 10>, 10>& Creal){
/* om = m*Omega */
/* v slicing is the default */
Creal[0][0]=(8-6*r)/((-2+r)*pow(r,3));
Creal[0][1]=0;
Creal[0][2]=0;
Creal[0][3]=0;
Creal[0][4]=(2*(-2+r)*(-3+2*r))/pow(r,5);
Creal[0][5]=0;
Creal[0][6]=0;
Creal[0][7]=(4-2*r)/pow(r,4);
Creal[0][8]=0;
Creal[0][9]=(4-2*r)/pow(r,4);
Creal[1][0]=r/(-2+r);
Creal[1][1]=1;
Creal[1][2]=0;
Creal[1][3]=0;
...
Creal[4][2]=0;
Creal[4][3]=0;
Creal[4][4]=(2+4*r)/pow(r,3);
Creal[4][5]=(-8*z)/pow(r,2);
Creal[4][6]=0;
Creal[4][7]=-2/pow(r,2);
Creal[4][8]=0;
Creal[4][9]=-2/pow(r,2);
...
Creal[5][3]=0;
Creal[5][4]=0;
Creal[5][5]=(-8+6*r)/pow(r,3);
Creal[5][6]=0;
Creal[5][7]=(2*z)/(pow(r,2)*(-1+pow(z,2)));
Creal[5][8]=0;
Creal[5][9]=(-2*z)/(pow(r,2)*(-1+pow(z,2)));
Creal[6][0]=0;
Creal[6][1]=0;
Creal[6][2]=0;
Creal[6][3]=r/(-2+r);
...
Creal[6][8]=0;
Creal[6][9]=0;
Creal[7][0]=(2*(-4+r))/((-2+r)*pow(r,2));
Creal[7][1]=0;
Creal[7][2]=0;
Creal[7][3]=0;
Creal[7][4]=(-2*(-3+r)*(-2+r))/pow(r,4);
Creal[7][5]=(4*(-2+r)*z)/pow(r,3);
Creal[7][6]=0;
Creal[7][7]=(-2*(-1+r+pow(z,2)))/(pow(r,3)*(-1+pow(z,2)));
Creal[7][8]=0;
Creal[7][9]=(4+2*(-2+r)*pow(z,2))/(pow(r,3)*(-1+pow(z,2)));
Creal[8][0]=0;
Creal[8][1]=0;
Creal[8][2]=0;
Creal[8][3]=0;
...
Creal[8][8]=1;
Creal[8][9]=0;
Creal[9][0]=(2*(-4+r))/((-2+r)*pow(r,2));
Creal[9][1]=0;
Creal[9][2]=0;
Creal[9][3]=0;
Creal[9][4]=(-2*(-3+r)*(-2+r))/pow(r,4);
Creal[9][5]=(4*(-2+r)*z)/pow(r,3);
Creal[9][6]=0;
Creal[9][7]=(4+2*(-2+r)*pow(z,2))/(pow(r,3)*(-1+pow(z,2)));
Creal[9][8]=0;
Creal[9][9]=(-2*(-1+r+pow(z,2)))/(pow(r,3)*(-1+pow(z,2)));
}
...
Cimag[3][7]=0;
Cimag[3][8]=(-4*a*a*om*r*r*z*(-1+z*z))/((a*a+r*r)*pow(r*r+a*a*z*z,2));
Cimag[3][9]=0;
Cimag[4][0]=0;
...
Cimag[5][8]=(2*a*om*r*r*(-1+z*z))/((a*a+r*r)*(r*r+a*a*z*z));
Cimag[5][9]=0;
Cimag[6][0]=0;
Cimag[6][1]=0;
Cimag[6][2]=0;
...
Cimag[6][7]=0;
Cimag[6][8]=(-2*a*a*om*r*z*(-1+z*z))/((a*a+r*r)*(r*r+a*a*z*z));
...
Cimag[7][8]=(-4*a*a*a*om*z*pow(-1+z*z,2))/((a*a+r*r)*(r*r+a*a*z*z));
Cimag[7][9]=0;
Cimag[8][0]=0;
Cimag[8][1]=0;
Cimag[8][2]=0;
Cimag[8][3]=(-2*a*a*om*z)/(r*r*r+a*a*r*z*z);
Cimag[8][4]=0;
Cimag[8][5]=(-2*a*om*(3*r*r*r*r-a*a*a*a*z*z+a*a*r*r*(1+z*z)))/(r*(a*a+r*r)*pow(r*r+a*a*z*z,2));
Cimag[8][6]=(-2*a*a*om*z)/(r*r*r+a*a*r*z*z);
Cimag[8][7]=(-4*a*a*a*om*r*z)/((a*a+r*r)*pow(r*r+a*a*z*z,2));
Cimag[8][8]=(2*a*a*om*z*z)/(r*r*r+a*a*r*z*z);
Cimag[8][9]=(-2*a*a*a*om*z)/((a*a+r*r)*(r*r+a*a*z*z));
Cimag[9][0]=0;
Cimag[9][1]=0;
Cimag[9][2]=0;
Cimag[9][3]=0;
...
Cimag[9][7]=0;
Cimag[9][8]=(-8*a*a*a*om*r*z*pow(-1+z*z,2))/((a*a+r*r)*pow(r*r+a*a*z*z,2));
...
Cimag[7][7]+=-((om*(dHdr*r*r*r*r*r+a*a*a*a*(2+2*H+dHdr*r)*z*z+a*a*r*r*(-2-2*H+dHdr*r+(4+4*H+dHdr*r)*z*z)))/(r*(a*a+r*r)*(r*r+a*a*z*z)));
Cimag[7][8]+=(4*a*a*a*(1+H)*om*z*pow(-1+z*z,2))/((a*a+(-2+r)*r)*(r*r+a*a*z*z));
...
Cimag[8][8]+=-((om*(dHdr*(-2+r)*pow(r,8)+pow(a,8)*(2+2*H+dHdr*r)*z*z*z*z+2*a*a*r*r*r*r*r*(3+3*H-dHdr*r+dHdr*r*r+(-5+H*(-5+r)+r+dHdr*(-2+r)*r)*z*z)+2*a*a*a*a*a*a*r*z*z*(-1-H+r+H*r+dHdr*r*r+(-1+(2+dHdr*(-1+r))*r+H*(-1+2*r))*z*z)+a*a*a*a*r*r*r*(2+2*H+dHdr*r*r+4*(-1+r)*(1+H+dHdr*r)*z*z+(-6+2*H*(-3+r)+(2+dHdr*(-2+r))*r)*z*z*z*z)))/(r*(a*a+(-2+r)*r)*(a*a+r*r)*pow(r*r+a*a*z*z,2)));
Cimag[8][9]+=(2*a*a*a*(1+H)*om*z)/((a*a+(-2+r)*r)*(r*r+a*a*z*z));
...
void getCimag_vrz_reduced(int /*m*/, double /*a*/, double /*om*/, double /*r*/, double /*z*/, double /*H*/, double /*dHdr*/, std::array<std::array<double, 10>, 10>& Cimag){
/* om = m*Omega */
/* v slicing is the default */
std::fill(Cimag[0].data(), Cimag[0].data() + 100, 0.0);
