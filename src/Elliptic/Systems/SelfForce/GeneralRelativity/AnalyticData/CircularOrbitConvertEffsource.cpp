...
void convert_effsource_psi_vrz(int m, double a, double r, double z, std::array<double, 10>& real_orig, std::array<double, 10>& imag_orig, std::array<double, 10>& real_conv, std::array<double, 10>& imag_conv){
double sinth = sqrt(1-z*z);
double rplus = 1+sqrt(1-a*a);
double rminus = 1-sqrt(1-a*a);
double mdphi = m*a/(rplus-rminus)*log((r-rplus)/(r-rminus));
...
real_conv[1] = factor*((real_orig[1]-(real_orig[3]*a)/(a*a-2*r+r*r)+(real_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[1]-(imag_orig[3]*a)/(a*a-2*r+r*r)+(imag_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r;
imag_conv[1] = factor*((imag_orig[1]-(imag_orig[3]*a)/(a*a-2*r+r*r)+(imag_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[1]-(real_orig[3]*a)/(a*a-2*r+r*r)+(real_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r;
real_conv[2] = factor*((real_orig[2])*cosmdphi+(imag_orig[2])*sinmdphi)*(-1)/sinth;
imag_conv[2] = factor*((imag_orig[2])*cosmdphi-(real_orig[2])*sinmdphi)*(-1)/sinth;
real_conv[3] = factor*((real_orig[3])*cosmdphi+(imag_orig[3])*sinmdphi)/(sinth*sinth);
imag_conv[3] = factor*((imag_orig[3])*cosmdphi-(real_orig[3])*sinmdphi)/(sinth*sinth);
real_conv[4] = factor*((real_orig[4]+(real_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*real_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(real_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*real_orig[6]*a)/(a*a-2*r+r*r)+(2*real_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[4]+(imag_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*imag_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(imag_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*imag_orig[6]*a)/(a*a-2*r+r*r)+(2*imag_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r;
imag_conv[4] = factor*((imag_orig[4]+(imag_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*imag_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(imag_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*imag_orig[6]*a)/(a*a-2*r+r*r)+(2*imag_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[4]+(real_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*real_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(real_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*real_orig[6]*a)/(a*a-2*r+r*r)+(2*real_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r;
real_conv[5] = factor*((real_orig[5]-(real_orig[8]*a)/(a*a-2*r+r*r)+(real_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[5]-(imag_orig[8]*a)/(a*a-2*r+r*r)+(imag_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(-1)/sinth;
imag_conv[5] = factor*((imag_orig[5]-(imag_orig[8]*a)/(a*a-2*r+r*r)+(imag_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[5]-(real_orig[8]*a)/(a*a-2*r+r*r)+(real_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(-1)/sinth;
real_conv[6] = factor*((real_orig[6]-(real_orig[9]*a)/(a*a-2*r+r*r)+(real_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[6]-(imag_orig[9]*a)/(a*a-2*r+r*r)+(imag_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)/(sinth*sinth);
...
factor = 1.0/(2*M_PI);
real_conv[0] = factor*((real_orig[0])*cosmdphi+(imag_orig[0])*sinmdphi)*r/(sinth);
imag_conv[0] = factor*((imag_orig[0])*cosmdphi-(real_orig[0])*sinmdphi)*r/(sinth);
real_conv[1] = factor*((real_orig[1]-(real_orig[3]*a)/(a*a-2*r+r*r)+(real_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[1]-(imag_orig[3]*a)/(a*a-2*r+r*r)+(imag_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r/(sinth);
imag_conv[1] = factor*((imag_orig[1]-(imag_orig[3]*a)/(a*a-2*r+r*r)+(imag_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[1]-(real_orig[3]*a)/(a*a-2*r+r*r)+(real_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r/(sinth);
real_conv[2] = factor*((real_orig[2])*cosmdphi+(imag_orig[2])*sinmdphi)*(-1);
imag_conv[2] = factor*((imag_orig[2])*cosmdphi-(real_orig[2])*sinmdphi)*(-1);
real_conv[3] = factor*((real_orig[3])*cosmdphi+(imag_orig[3])*sinmdphi)/(sinth);
imag_conv[3] = factor*((imag_orig[3])*cosmdphi-(real_orig[3])*sinmdphi)/(sinth);
real_conv[4] = factor*((real_orig[4]+(real_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*real_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(real_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*real_orig[6]*a)/(a*a-2*r+r*r)+(2*real_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[4]+(imag_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*imag_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(imag_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*imag_orig[6]*a)/(a*a-2*r+r*r)+(2*imag_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r/(sinth);
imag_conv[4] = factor*((imag_orig[4]+(imag_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*imag_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(imag_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*imag_orig[6]*a)/(a*a-2*r+r*r)+(2*imag_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[4]+(real_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*real_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(real_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*real_orig[6]*a)/(a*a-2*r+r*r)+(2*real_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r/(sinth);
real_conv[5] = factor*((real_orig[5]-(real_orig[8]*a)/(a*a-2*r+r*r)+(real_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[5]-(imag_orig[8]*a)/(a*a-2*r+r*r)+(imag_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(-1);
imag_conv[5] = factor*((imag_orig[5]-(imag_orig[8]*a)/(a*a-2*r+r*r)+(imag_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[5]-(real_orig[8]*a)/(a*a-2*r+r*r)+(real_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(-1);
real_conv[6] = factor*((real_orig[6]-(real_orig[9]*a)/(a*a-2*r+r*r)+(real_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[6]-(imag_orig[9]*a)/(a*a-2*r+r*r)+(imag_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)/(sinth);
imag_conv[6] = factor*((imag_orig[6]-(imag_orig[9]*a)/(a*a-2*r+r*r)+(imag_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[6]-(real_orig[9]*a)/(a*a-2*r+r*r)+(real_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)/(sinth);
real_conv[7] = factor*(real_orig[7]*cosmdphi+imag_orig[7]*sinmdphi)/(r*sinth);
imag_conv[7] = factor*(imag_orig[7]*cosmdphi-real_orig[7]*sinmdphi)/(r*sinth);
real_conv[8] = factor*(real_orig[8]*cosmdphi+imag_orig[8]*sinmdphi)/(-sinth*sinth*r);
imag_conv[8] = factor*(imag_orig[8]*cosmdphi-real_orig[8]*sinmdphi)/(-sinth*sinth*r);
real_conv[9] = factor*(real_orig[9]*cosmdphi+imag_orig[9]*sinmdphi)/(r*sinth*sinth*sinth);
imag_conv[9] = factor*(imag_orig[9]*cosmdphi-real_orig[9]*sinmdphi)/(r*sinth*sinth*sinth);
} else {
factor = 1.0/(2*M_PI*pow(sinth,m-2));
real_conv[0] = factor*((real_orig[0])*cosmdphi+(imag_orig[0])*sinmdphi)*r/(sinth*sinth);
imag_conv[0] = factor*((imag_orig[0])*cosmdphi-(real_orig[0])*sinmdphi)*r/(sinth*sinth);
real_conv[1] = factor*((real_orig[1]-(real_orig[3]*a)/(a*a-2*r+r*r)+(real_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[1]-(imag_orig[3]*a)/(a*a-2*r+r*r)+(imag_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r/(sinth*sinth);
imag_conv[1] = factor*((imag_orig[1]-(imag_orig[3]*a)/(a*a-2*r+r*r)+(imag_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[1]-(real_orig[3]*a)/(a*a-2*r+r*r)+(real_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r/(sinth*sinth);
real_conv[2] = factor*((real_orig[2])*cosmdphi+(imag_orig[2])*sinmdphi)/(-sinth);
imag_conv[2] = factor*((imag_orig[2])*cosmdphi-(real_orig[2])*sinmdphi)/(-sinth);
real_conv[3] = factor*((real_orig[3])*cosmdphi+(imag_orig[3])*sinmdphi)/(sinth*sinth);
imag_conv[3] = factor*((imag_orig[3])*cosmdphi-(real_orig[3])*sinmdphi)/(sinth*sinth);
real_conv[4] = factor*((real_orig[4]+(real_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*real_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(real_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*real_orig[6]*a)/(a*a-2*r+r*r)+(2*real_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[4]+(imag_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*imag_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(imag_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*imag_orig[6]*a)/(a*a-2*r+r*r)+(2*imag_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r/(sinth*sinth);
imag_conv[4] = factor*((imag_orig[4]+(imag_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*imag_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(imag_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*imag_orig[6]*a)/(a*a-2*r+r*r)+(2*imag_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[4]+(real_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*real_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(real_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*real_orig[6]*a)/(a*a-2*r+r*r)+(2*real_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r/(sinth*sinth);
real_conv[5] = factor*((real_orig[5]-(real_orig[8]*a)/(a*a-2*r+r*r)+(real_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[5]-(imag_orig[8]*a)/(a*a-2*r+r*r)+(imag_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)/(-sinth);
imag_conv[5] = factor*((imag_orig[5]-(imag_orig[8]*a)/(a*a-2*r+r*r)+(imag_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[5]-(real_orig[8]*a)/(a*a-2*r+r*r)+(real_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)/(-sinth);
real_conv[6] = factor*((real_orig[6]-(real_orig[9]*a)/(a*a-2*r+r*r)+(real_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[6]-(imag_orig[9]*a)/(a*a-2*r+r*r)+(imag_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)/(sinth*sinth);
imag_conv[6] = factor*((imag_orig[6]-(imag_orig[9]*a)/(a*a-2*r+r*r)+(imag_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[6]-(real_orig[9]*a)/(a*a-2*r+r*r)+(real_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)/(sinth*sinth);
real_conv[7] = factor*(real_orig[7]*cosmdphi+imag_orig[7]*sinmdphi)/r;
imag_conv[7] = factor*(imag_orig[7]*cosmdphi-real_orig[7]*sinmdphi)/r;
...
void convert_effsource_Seff_vrz(int m, double a, double r, double z, std::array<double, 10>& real_orig, std::array<double, 10>& imag_orig, std::array<double, 10>& real_conv, std::array<double, 10>& imag_conv){
double sinth = sqrt(1-z*z);
double rplus = 1+sqrt(1-a*a);
double rminus = 1-sqrt(1-a*a);
double mdphi = m*a/(rplus-rminus)*log((r-rplus)/(r-rminus));
...
real_conv[1] = factor*((real_orig[1]-(real_orig[3]*a)/(a*a-2*r+r*r)+(real_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[1]-(imag_orig[3]*a)/(a*a-2*r+r*r)+(imag_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(r*(r*r + a*a*z*z))/(a*a + r*r);
imag_conv[1] = factor*((imag_orig[1]-(imag_orig[3]*a)/(a*a-2*r+r*r)+(imag_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[1]-(real_orig[3]*a)/(a*a-2*r+r*r)+(real_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(r*(r*r + a*a*z*z))/(a*a + r*r);
real_conv[2] = factor*(real_orig[2]*cosmdphi+imag_orig[2]*sinmdphi)*(r*r + a*a*z*z)/((a*a + r*r)*sinth*-1);
imag_conv[2] = factor*(imag_orig[2]*cosmdphi-real_orig[2]*sinmdphi)*(r*r + a*a*z*z)/((a*a + r*r)*sinth*-1);
real_conv[3] = factor*(real_orig[3]*cosmdphi+imag_orig[3]*sinmdphi)*(r*r + a*a*z*z)/((a*a + r*r)*sinth*sinth);
imag_conv[3] = factor*(imag_orig[3]*cosmdphi-real_orig[3]*sinmdphi)*(r*r + a*a*z*z)/((a*a + r*r)*sinth*sinth);
real_conv[4] = factor*((real_orig[4]+(real_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*real_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(real_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*real_orig[6]*a)/(a*a-2*r+r*r)+(2*real_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[4]+(imag_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*imag_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(imag_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*imag_orig[6]*a)/(a*a-2*r+r*r)+(2*imag_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(r*(r*r + a*a*z*z))/((a*a + r*r));
imag_conv[4] = factor*((imag_orig[4]+(imag_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*imag_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(imag_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*imag_orig[6]*a)/(a*a-2*r+r*r)+(2*imag_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[4]+(real_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*real_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(real_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*real_orig[6]*a)/(a*a-2*r+r*r)+(2*real_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(r*(r*r + a*a*z*z))/((a*a + r*r));
real_conv[5] = factor*((real_orig[5]-(real_orig[8]*a)/(a*a-2*r+r*r)+(real_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[5]-(imag_orig[8]*a)/(a*a-2*r+r*r)+(imag_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(r*r + a*a*z*z)/(a*a + r*r)/(sinth*-1);
imag_conv[5] = factor*((imag_orig[5]-(imag_orig[8]*a)/(a*a-2*r+r*r)+(imag_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[5]-(real_orig[8]*a)/(a*a-2*r+r*r)+(real_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(r*r + a*a*z*z)/(a*a + r*r)/(sinth*-1);
real_conv[6] = factor*((real_orig[6]-(real_orig[9]*a)/(a*a-2*r+r*r)+(real_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[6]-(imag_orig[9]*a)/(a*a-2*r+r*r)+(imag_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(r*r + a*a*z*z)/((a*a + r*r)*sinth*sinth);
...
factor = 1.0/(2*M_PI);
real_conv[0] = factor*(real_orig[0]*cosmdphi+imag_orig[0]*sinmdphi)*(r*(r*r + a*a*z*z))/((a*a + r*r)*sinth);
imag_conv[0] = factor*(imag_orig[0]*cosmdphi-real_orig[0]*sinmdphi)*(r*(r*r + a*a*z*z))/((a*a + r*r)*sinth);
real_conv[1] = factor*((real_orig[1]-(real_orig[3]*a)/(a*a-2*r+r*r)+(real_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[1]-(imag_orig[3]*a)/(a*a-2*r+r*r)+(imag_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(r*(r*r + a*a*z*z))/((a*a + r*r)*sinth);
imag_conv[1] = factor*((imag_orig[1]-(imag_orig[3]*a)/(a*a-2*r+r*r)+(imag_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[1]-(real_orig[3]*a)/(a*a-2*r+r*r)+(real_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(r*(r*r + a*a*z*z))/((a*a + r*r)*sinth);
real_conv[2] = factor*(real_orig[2]*cosmdphi+imag_orig[2]*sinmdphi)*(-1*(r*r + a*a*z*z))/(a*a + r*r);
imag_conv[2] = factor*(imag_orig[2]*cosmdphi-real_orig[2]*sinmdphi)*(-1*(r*r + a*a*z*z))/(a*a + r*r);
real_conv[3] = factor*(real_orig[3]*cosmdphi+imag_orig[3]*sinmdphi)*(r*r + a*a*z*z)/((a*a + r*r)*sinth);
imag_conv[3] = factor*(imag_orig[3]*cosmdphi-real_orig[3]*sinmdphi)*(r*r + a*a*z*z)/((a*a + r*r)*sinth);
real_conv[4] = factor*((real_orig[4]+(real_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*real_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(real_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*real_orig[6]*a)/(a*a-2*r+r*r)+(2*real_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[4]+(imag_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*imag_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(imag_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*imag_orig[6]*a)/(a*a-2*r+r*r)+(2*imag_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(r*(r*r + a*a*z*z))/((a*a + r*r)*sinth);
imag_conv[4] = factor*((imag_orig[4]+(imag_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*imag_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(imag_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*imag_orig[6]*a)/(a*a-2*r+r*r)+(2*imag_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[4]+(real_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*real_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(real_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*real_orig[6]*a)/(a*a-2*r+r*r)+(2*real_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(r*(r*r + a*a*z*z))/((a*a + r*r)*sinth);
real_conv[5] = factor*((real_orig[5]-(real_orig[8]*a)/(a*a-2*r+r*r)+(real_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[5]-(imag_orig[8]*a)/(a*a-2*r+r*r)+(imag_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(-1*(r*r + a*a*z*z))/(a*a + r*r);
imag_conv[5] = factor*((imag_orig[5]-(imag_orig[8]*a)/(a*a-2*r+r*r)+(imag_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[5]-(real_orig[8]*a)/(a*a-2*r+r*r)+(real_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(-1*(r*r + a*a*z*z))/(a*a + r*r);
real_conv[6] = factor*((real_orig[6]-(real_orig[9]*a)/(a*a-2*r+r*r)+(real_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[6]-(imag_orig[9]*a)/(a*a-2*r+r*r)+(imag_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(r*r + a*a*z*z)/((a*a + r*r)*sinth);
imag_conv[6] = factor*((imag_orig[6]-(imag_orig[9]*a)/(a*a-2*r+r*r)+(imag_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[6]-(real_orig[9]*a)/(a*a-2*r+r*r)+(real_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(r*r + a*a*z*z)/((a*a + r*r)*sinth);
real_conv[7] = factor*(real_orig[7]*cosmdphi+imag_orig[7]*sinmdphi)*((r*r + a*a*z*z))/(sinth*r*(a*a + r*r));
imag_conv[7] = factor*(imag_orig[7]*cosmdphi-real_orig[7]*sinmdphi)*((r*r + a*a*z*z))/(sinth*r*(a*a + r*r));
real_conv[8] = factor*(real_orig[8]*cosmdphi+imag_orig[8]*sinmdphi)*(r*r + a*a*z*z)/(r*(a*a + r*r)*sinth*sinth*-1);
imag_conv[8] = factor*(imag_orig[8]*cosmdphi-real_orig[8]*sinmdphi)*(r*r + a*a*z*z)/(r*(a*a + r*r)*sinth*sinth*-1);
real_conv[9] = factor*(real_orig[9]*cosmdphi+imag_orig[9]*sinmdphi)*(r*r + a*a*z*z)/(r*(a*a + r*r)*sinth*sinth*sinth);
imag_conv[9] = factor*(imag_orig[9]*cosmdphi-real_orig[9]*sinmdphi)*(r*r + a*a*z*z)/(r*(a*a + r*r)*sinth*sinth*sinth);
} else {
factor = 1.0/(2*M_PI*pow(sinth,m));
real_conv[0] = factor*(real_orig[0]*cosmdphi+imag_orig[0]*sinmdphi)*(r*r*r + a*a*r*z*z)/(a*a + r*r);
imag_conv[0] = factor*(imag_orig[0]*cosmdphi-real_orig[0]*sinmdphi)*(r*r*r + a*a*r*z*z)/(a*a + r*r);
real_conv[1] = factor*((real_orig[1]-(real_orig[3]*a)/(a*a-2*r+r*r)+(real_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[1]-(imag_orig[3]*a)/(a*a-2*r+r*r)+(imag_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(r*r*r + a*a*r*z*z)/(a*a + r*r);
imag_conv[1] = factor*((imag_orig[1]-(imag_orig[3]*a)/(a*a-2*r+r*r)+(imag_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[1]-(real_orig[3]*a)/(a*a-2*r+r*r)+(real_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(r*r*r + a*a*r*z*z)/(a*a + r*r);
real_conv[2] = factor*(real_orig[2]*cosmdphi+imag_orig[2]*sinmdphi)*((r*r + a*a*z*z)*(-sinth))/(a*a + r*r);
imag_conv[2] = factor*(imag_orig[2]*cosmdphi-real_orig[2]*sinmdphi)*((r*r + a*a*z*z)*(-sinth))/(a*a + r*r);
real_conv[3] = factor*(real_orig[3]*cosmdphi+imag_orig[3]*sinmdphi)*(r*r + a*a*z*z)/(a*a + r*r);
imag_conv[3] = factor*(imag_orig[3]*cosmdphi-real_orig[3]*sinmdphi)*(r*r + a*a*z*z)/(a*a + r*r);
real_conv[4] = factor*((real_orig[4]+(real_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*real_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(real_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*real_orig[6]*a)/(a*a-2*r+r*r)+(2*real_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[4]+(imag_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*imag_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(imag_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*imag_orig[6]*a)/(a*a-2*r+r*r)+(2*imag_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(r*r*r + a*a*r*z*z)/(a*a + r*r);
imag_conv[4] = factor*((imag_orig[4]+(imag_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*imag_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(imag_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*imag_orig[6]*a)/(a*a-2*r+r*r)+(2*imag_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[4]+(real_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*real_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(real_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*real_orig[6]*a)/(a*a-2*r+r*r)+(2*real_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(r*r*r + a*a*r*z*z)/(a*a + r*r);
real_conv[5] = factor*((real_orig[5]-(real_orig[8]*a)/(a*a-2*r+r*r)+(real_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[5]-(imag_orig[8]*a)/(a*a-2*r+r*r)+(imag_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*((r*r + a*a*z*z)*(-sinth))/(a*a + r*r);
imag_conv[5] = factor*((imag_orig[5]-(imag_orig[8]*a)/(a*a-2*r+r*r)+(imag_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[5]-(real_orig[8]*a)/(a*a-2*r+r*r)+(real_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*((r*r + a*a*z*z)*(-sinth))/(a*a + r*r);
real_conv[6] = factor*((real_orig[6]-(real_orig[9]*a)/(a*a-2*r+r*r)+(real_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[6]-(imag_orig[9]*a)/(a*a-2*r+r*r)+(imag_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(r*r + a*a*z*z)/(a*a + r*r);
imag_conv[6] = factor*((imag_orig[6]-(imag_orig[9]*a)/(a*a-2*r+r*r)+(imag_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[6]-(real_orig[9]*a)/(a*a-2*r+r*r)+(real_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(r*r + a*a*z*z)/(a*a + r*r);
real_conv[7] = factor*(real_orig[7]*cosmdphi+imag_orig[7]*sinmdphi)*((r*r + a*a*z*z)*sinth*sinth)/(r*(a*a + r*r));
imag_conv[7] = factor*(imag_orig[7]*cosmdphi-real_orig[7]*sinmdphi)*((r*r + a*a*z*z)*sinth*sinth)/(r*(a*a + r*r));
real_conv[8] = factor*(real_orig[8]*cosmdphi+imag_orig[8]*sinmdphi)*((r*r + a*a*z*z)*(-sinth))/(r*(a*a + r*r));
imag_conv[8] = factor*(imag_orig[8]*cosmdphi-real_orig[8]*sinmdphi)*((r*r + a*a*z*z)*(-sinth))/(r*(a*a + r*r));
real_conv[9] = factor*(real_orig[9]*cosmdphi+imag_orig[9]*sinmdphi)*(r*r + a*a*z*z)/(a*a*r + r*r*r);
imag_conv[9] = factor*(imag_orig[9]*cosmdphi-real_orig[9]*sinmdphi)*(r*r + a*a*z*z)/(a*a*r + r*r*r);
}
}

void convert_effsource_dpsidz_vrz(int m, double a, double r, double z, std::array<double, 10>& real_orig, std::array<double, 10>& imag_orig, std::array<double, 10>& real_orig_dth, std::array<double, 10>& imag_orig_dth, std::array<double, 10>& real_conv_dz, std::array<double, 10>& imag_conv_dz){
double sinth = sqrt(1-z*z);
// double dthdz = -1.0/sinth;
double rplus = 1+sqrt(1-a*a);
double rminus = 1-sqrt(1-a*a);
...
if (m==0) {
factor = 1.0/(2*M_PI);
real_conv_dz[0] = factor*((real_orig_dth[0])*cosmdphi+(imag_orig_dth[0])*sinmdphi)*r/(sinth*-1);
imag_conv_dz[0] = factor*((imag_orig_dth[0])*cosmdphi-(real_orig_dth[0])*sinmdphi)*r/(sinth*-1);
real_conv_dz[1] = factor*((real_orig_dth[1]-(real_orig_dth[3]*a)/(a*a-2*r+r*r)+(real_orig_dth[0]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig_dth[1]-(imag_orig_dth[3]*a)/(a*a-2*r+r*r)+(imag_orig_dth[0]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r/(sinth*-1);
imag_conv_dz[1] = factor*((imag_orig_dth[1]-(imag_orig_dth[3]*a)/(a*a-2*r+r*r)+(imag_orig_dth[0]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig_dth[1]-(real_orig_dth[3]*a)/(a*a-2*r+r*r)+(real_orig_dth[0]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r/(sinth*-1);
real_conv_dz[2] = factor*((real_orig[2])*cosmdphi+(imag_orig[2])*sinmdphi)*(-1)*(z/(sinth*sinth*sinth)) + factor*((real_orig_dth[2])*cosmdphi+(imag_orig_dth[2])*sinmdphi)/(sinth*sinth);
imag_conv_dz[2] = factor*((imag_orig[2])*cosmdphi-(real_orig[2])*sinmdphi)*(-1)*(z/(sinth*sinth*sinth)) + factor*((imag_orig_dth[2])*cosmdphi-(real_orig_dth[2])*sinmdphi)/(sinth*sinth);
real_conv_dz[3] = factor*((real_orig[3])*cosmdphi+(imag_orig[3])*sinmdphi)*(2*z)/(sinth*sinth*sinth*sinth) + factor*((real_orig_dth[3])*cosmdphi+(imag_orig_dth[3])*sinmdphi)/(sinth*sinth*sinth*-1);
imag_conv_dz[3] = factor*((imag_orig[3])*cosmdphi-(real_orig[3])*sinmdphi)*(2*z)/(sinth*sinth*sinth*sinth) + factor*((imag_orig_dth[3])*cosmdphi-(real_orig_dth[3])*sinmdphi)/(sinth*sinth*sinth*-1);
real_conv_dz[4] = factor*((real_orig_dth[4]+(real_orig_dth[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*real_orig_dth[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(real_orig_dth[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*real_orig_dth[6]*a)/(a*a-2*r+r*r)+(2*real_orig_dth[1]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig_dth[4]+(imag_orig_dth[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*imag_orig_dth[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(imag_orig_dth[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*imag_orig_dth[6]*a)/(a*a-2*r+r*r)+(2*imag_orig_dth[1]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r/(sinth*-1);
imag_conv_dz[4] = factor*((imag_orig_dth[4]+(imag_orig_dth[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*imag_orig_dth[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(imag_orig_dth[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*imag_orig_dth[6]*a)/(a*a-2*r+r*r)+(2*imag_orig_dth[1]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig_dth[4]+(real_orig_dth[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*real_orig_dth[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(real_orig_dth[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*real_orig_dth[6]*a)/(a*a-2*r+r*r)+(2*real_orig_dth[1]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r/(sinth*-1);
real_conv_dz[5] = factor*((real_orig[5]-(real_orig[8]*a)/(a*a-2*r+r*r)+(real_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[5]-(imag_orig[8]*a)/(a*a-2*r+r*r)+(imag_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(-1)*(z/(sinth*sinth*sinth)) + factor*((real_orig_dth[5]-(real_orig_dth[8]*a)/(a*a-2*r+r*r)+(real_orig_dth[2]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig_dth[5]-(imag_orig_dth[8]*a)/(a*a-2*r+r*r)+(imag_orig_dth[2]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)/(sinth*sinth);
imag_conv_dz[5] = factor*((imag_orig[5]-(imag_orig[8]*a)/(a*a-2*r+r*r)+(imag_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[5]-(real_orig[8]*a)/(a*a-2*r+r*r)+(real_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(-1)*(z/(sinth*sinth*sinth)) + factor*((imag_orig_dth[5]-(imag_orig_dth[8]*a)/(a*a-2*r+r*r)+(imag_orig_dth[2]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig_dth[5]-(real_orig_dth[8]*a)/(a*a-2*r+r*r)+(real_orig_dth[2]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)/(sinth*sinth);
real_conv_dz[6] = factor*((real_orig[6]-(real_orig[9]*a)/(a*a-2*r+r*r)+(real_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[6]-(imag_orig[9]*a)/(a*a-2*r+r*r)+(imag_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(2*z)/(sinth*sinth*sinth*sinth) + factor*((real_orig_dth[6]-(real_orig_dth[9]*a)/(a*a-2*r+r*r)+(real_orig_dth[3]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig_dth[6]-(imag_orig_dth[9]*a)/(a*a-2*r+r*r)+(imag_orig_dth[3]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)/(sinth*sinth*sinth*-1);
...
real_conv_dz[8] = factor*(real_orig[8]*cosmdphi+imag_orig[8]*sinmdphi)*(-3*z)/(r*sinth*sinth*sinth*sinth*sinth) + factor*(real_orig_dth[8]*cosmdphi+imag_orig_dth[8]*sinmdphi)/(sinth*r*sinth*sinth*sinth);
imag_conv_dz[8] = factor*(imag_orig[8]*cosmdphi-real_orig[8]*sinmdphi)*(-3*z)/(r*sinth*sinth*sinth*sinth*sinth) + factor*(imag_orig_dth[8]*cosmdphi-real_orig_dth[8]*sinmdphi)/(sinth*r*sinth*sinth*sinth);
...
factor = 1.0/(2*M_PI);
real_conv_dz[0] = factor*((real_orig[0])*cosmdphi+(imag_orig[0])*sinmdphi)*r*z/(sinth*sinth*sinth) + factor*((real_orig_dth[0])*cosmdphi+(imag_orig_dth[0])*sinmdphi)*r/(sinth*sinth*-1);
imag_conv_dz[0] = factor*((imag_orig[0])*cosmdphi-(real_orig[0])*sinmdphi)*r*z/(sinth*sinth*sinth) + factor*((imag_orig_dth[0])*cosmdphi-(real_orig_dth[0])*sinmdphi)*r/(sinth*sinth*-1);
real_conv_dz[1] = factor*((real_orig[1]-(real_orig[3]*a)/(a*a-2*r+r*r)+(real_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[1]-(imag_orig[3]*a)/(a*a-2*r+r*r)+(imag_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r*z/(sinth*sinth*sinth) + factor*((real_orig_dth[1]-(real_orig_dth[3]*a)/(a*a-2*r+r*r)+(real_orig_dth[0]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig_dth[1]-(imag_orig_dth[3]*a)/(a*a-2*r+r*r)+(imag_orig_dth[0]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r/(sinth*sinth*-1);
imag_conv_dz[1] = factor*((imag_orig[1]-(imag_orig[3]*a)/(a*a-2*r+r*r)+(imag_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[1]-(real_orig[3]*a)/(a*a-2*r+r*r)+(real_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r*z/(sinth*sinth*sinth) + factor*((imag_orig_dth[1]-(imag_orig_dth[3]*a)/(a*a-2*r+r*r)+(imag_orig_dth[0]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig_dth[1]-(real_orig_dth[3]*a)/(a*a-2*r+r*r)+(real_orig_dth[0]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r/(sinth*sinth*-1);
real_conv_dz[2] = factor*((real_orig_dth[2])*cosmdphi+(imag_orig_dth[2])*sinmdphi)/sinth;
imag_conv_dz[2] = factor*((imag_orig_dth[2])*cosmdphi-(real_orig_dth[2])*sinmdphi)/sinth;
real_conv_dz[3] = factor*((real_orig[3])*cosmdphi+(imag_orig[3])*sinmdphi)*z/(sinth*sinth*sinth) + factor*((real_orig_dth[3])*cosmdphi+(imag_orig_dth[3])*sinmdphi)/(sinth*sinth*-1);
imag_conv_dz[3] = factor*((imag_orig[3])*cosmdphi-(real_orig[3])*sinmdphi)*z/(sinth*sinth*sinth) + factor*((imag_orig_dth[3])*cosmdphi-(real_orig_dth[3])*sinmdphi)/(sinth*sinth*-1);
real_conv_dz[4] = factor*((real_orig[4]+(real_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*real_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(real_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*real_orig[6]*a)/(a*a-2*r+r*r)+(2*real_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[4]+(imag_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*imag_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(imag_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*imag_orig[6]*a)/(a*a-2*r+r*r)+(2*imag_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r*z/(sinth*sinth*sinth) + factor*((real_orig_dth[4]+(real_orig_dth[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*real_orig_dth[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(real_orig_dth[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*real_orig_dth[6]*a)/(a*a-2*r+r*r)+(2*real_orig_dth[1]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig_dth[4]+(imag_orig_dth[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*imag_orig_dth[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(imag_orig_dth[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*imag_orig_dth[6]*a)/(a*a-2*r+r*r)+(2*imag_orig_dth[1]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r/(sinth*sinth*-1);
imag_conv_dz[4] = factor*((imag_orig[4]+(imag_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*imag_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(imag_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*imag_orig[6]*a)/(a*a-2*r+r*r)+(2*imag_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[4]+(real_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*real_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(real_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*real_orig[6]*a)/(a*a-2*r+r*r)+(2*real_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r*z/(sinth*sinth*sinth) + factor*((imag_orig_dth[4]+(imag_orig_dth[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*imag_orig_dth[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(imag_orig_dth[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*imag_orig_dth[6]*a)/(a*a-2*r+r*r)+(2*imag_orig_dth[1]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig_dth[4]+(real_orig_dth[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*real_orig_dth[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(real_orig_dth[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*real_orig_dth[6]*a)/(a*a-2*r+r*r)+(2*real_orig_dth[1]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r/(sinth*sinth*-1);
real_conv_dz[5] = factor*((real_orig_dth[5]-(real_orig_dth[8]*a)/(a*a-2*r+r*r)+(real_orig_dth[2]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig_dth[5]-(imag_orig_dth[8]*a)/(a*a-2*r+r*r)+(imag_orig_dth[2]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)/sinth;
imag_conv_dz[5] = factor*((imag_orig_dth[5]-(imag_orig_dth[8]*a)/(a*a-2*r+r*r)+(imag_orig_dth[2]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig_dth[5]-(real_orig_dth[8]*a)/(a*a-2*r+r*r)+(real_orig_dth[2]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)/sinth;
real_conv_dz[6] = factor*((real_orig[6]-(real_orig[9]*a)/(a*a-2*r+r*r)+(real_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[6]-(imag_orig[9]*a)/(a*a-2*r+r*r)+(imag_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*z/(sinth*sinth*sinth) + factor*((real_orig_dth[6]-(real_orig_dth[9]*a)/(a*a-2*r+r*r)+(real_orig_dth[3]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig_dth[6]-(imag_orig_dth[9]*a)/(a*a-2*r+r*r)+(imag_orig_dth[3]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)/(sinth*sinth*-1);
imag_conv_dz[6] = factor*((imag_orig[6]-(imag_orig[9]*a)/(a*a-2*r+r*r)+(imag_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[6]-(real_orig[9]*a)/(a*a-2*r+r*r)+(real_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*z/(sinth*sinth*sinth) + factor*((imag_orig_dth[6]-(imag_orig_dth[9]*a)/(a*a-2*r+r*r)+(imag_orig_dth[3]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig_dth[6]-(real_orig_dth[9]*a)/(a*a-2*r+r*r)+(real_orig_dth[3]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)/(sinth*sinth*-1);
real_conv_dz[7] = factor*(real_orig[7]*cosmdphi+imag_orig[7]*sinmdphi)*z/(r*sinth*sinth*sinth) + factor*(real_orig_dth[7]*cosmdphi+imag_orig_dth[7]*sinmdphi)/(r*sinth*sinth*-1);
imag_conv_dz[7] = factor*(imag_orig[7]*cosmdphi-real_orig[7]*sinmdphi)*z/(r*sinth*sinth*sinth) + factor*(imag_orig_dth[7]*cosmdphi-real_orig_dth[7]*sinmdphi)/(r*sinth*sinth*-1);
real_conv_dz[8] = factor*(real_orig[8]*cosmdphi+imag_orig[8]*sinmdphi)*(-2*z)/(r*sinth*sinth*sinth*sinth) + factor*(real_orig_dth[8]*cosmdphi+imag_orig_dth[8]*sinmdphi)/(sinth*sinth*sinth*r);
imag_conv_dz[8] = factor*(imag_orig[8]*cosmdphi-real_orig[8]*sinmdphi)*(-2*z)/(r*sinth*sinth*sinth*sinth) + factor*(imag_orig_dth[8]*cosmdphi-real_orig_dth[8]*sinmdphi)/(sinth*sinth*sinth*r);
real_conv_dz[9] = factor*(real_orig[9]*cosmdphi+imag_orig[9]*sinmdphi)*(3*z)/(r*sinth*sinth*sinth*sinth*sinth) + factor*(real_orig_dth[9]*cosmdphi+imag_orig_dth[9]*sinmdphi)/(r*sinth*sinth*sinth*sinth*-1);
imag_conv_dz[9] = factor*(imag_orig[9]*cosmdphi-real_orig[9]*sinmdphi)*(3*z)/(r*sinth*sinth*sinth*sinth*sinth) + factor*(imag_orig_dth[9]*cosmdphi-real_orig_dth[9]*sinmdphi)/(r*sinth*sinth*sinth*sinth*-1);
} else {
factor = 1.0/(2*M_PI*pow(sinth,m-2));
real_conv_dz[0] = factor*((real_orig[0])*cosmdphi+(imag_orig[0])*sinmdphi)*r*(m*z)/(sinth*sinth*sinth*sinth) + factor*((real_orig_dth[0])*cosmdphi+(imag_orig_dth[0])*sinmdphi)*r/(-sinth*sinth*sinth);
imag_conv_dz[0] = factor*((imag_orig[0])*cosmdphi-(real_orig[0])*sinmdphi)*r*(m*z)/(sinth*sinth*sinth*sinth) + factor*((imag_orig_dth[0])*cosmdphi-(real_orig_dth[0])*sinmdphi)*r/(-sinth*sinth*sinth);
real_conv_dz[1] = factor*((real_orig[1]-(real_orig[3]*a)/(a*a-2*r+r*r)+(real_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[1]-(imag_orig[3]*a)/(a*a-2*r+r*r)+(imag_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r*(m*z)/(sinth*sinth*sinth*sinth) + factor*((real_orig_dth[1]-(real_orig_dth[3]*a)/(a*a-2*r+r*r)+(real_orig_dth[0]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig_dth[1]-(imag_orig_dth[3]*a)/(a*a-2*r+r*r)+(imag_orig_dth[0]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r/(-sinth*sinth*sinth);
imag_conv_dz[1] = factor*((imag_orig[1]-(imag_orig[3]*a)/(a*a-2*r+r*r)+(imag_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[1]-(real_orig[3]*a)/(a*a-2*r+r*r)+(real_orig[0]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r*(m*z)/(sinth*sinth*sinth*sinth) + factor*((imag_orig_dth[1]-(imag_orig_dth[3]*a)/(a*a-2*r+r*r)+(imag_orig_dth[0]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig_dth[1]-(real_orig_dth[3]*a)/(a*a-2*r+r*r)+(real_orig_dth[0]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r/(-sinth*sinth*sinth);
real_conv_dz[2] = factor*((real_orig[2])*cosmdphi+(imag_orig[2])*sinmdphi)*((-1 + m)*(-z))/(sinth*sinth*sinth) + factor*((real_orig_dth[2])*cosmdphi+(imag_orig_dth[2])*sinmdphi)/(sinth*sinth);
imag_conv_dz[2] = factor*((imag_orig[2])*cosmdphi-(real_orig[2])*sinmdphi)*((-1 + m)*(-z))/(sinth*sinth*sinth) + factor*((imag_orig_dth[2])*cosmdphi-(real_orig_dth[2])*sinmdphi)/(sinth*sinth);
real_conv_dz[3] = factor*((real_orig[3])*cosmdphi+(imag_orig[3])*sinmdphi)*(m*z)/(sinth*sinth*sinth*sinth) + factor*((real_orig_dth[3])*cosmdphi+(imag_orig_dth[3])*sinmdphi)/(-sinth*sinth*sinth);
imag_conv_dz[3] = factor*((imag_orig[3])*cosmdphi-(real_orig[3])*sinmdphi)*(m*z)/(sinth*sinth*sinth*sinth) + factor*((imag_orig_dth[3])*cosmdphi-(real_orig_dth[3])*sinmdphi)/(-sinth*sinth*sinth);
real_conv_dz[4] = factor*((real_orig[4]+(real_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*real_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(real_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*real_orig[6]*a)/(a*a-2*r+r*r)+(2*real_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[4]+(imag_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*imag_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(imag_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*imag_orig[6]*a)/(a*a-2*r+r*r)+(2*imag_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r*(m*z)/(sinth*sinth*sinth*sinth) + factor*((real_orig_dth[4]+(real_orig_dth[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*real_orig_dth[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(real_orig_dth[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*real_orig_dth[6]*a)/(a*a-2*r+r*r)+(2*real_orig_dth[1]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig_dth[4]+(imag_orig_dth[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*imag_orig_dth[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(imag_orig_dth[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*imag_orig_dth[6]*a)/(a*a-2*r+r*r)+(2*imag_orig_dth[1]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r/(-sinth*sinth*sinth);
imag_conv_dz[4] = factor*((imag_orig[4]+(imag_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*imag_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(imag_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*imag_orig[6]*a)/(a*a-2*r+r*r)+(2*imag_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[4]+(real_orig[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*real_orig[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(real_orig[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*real_orig[6]*a)/(a*a-2*r+r*r)+(2*real_orig[1]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r*(m*z)/(sinth*sinth*sinth*sinth) + factor*((imag_orig_dth[4]+(imag_orig_dth[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*imag_orig_dth[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(imag_orig_dth[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*imag_orig_dth[6]*a)/(a*a-2*r+r*r)+(2*imag_orig_dth[1]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig_dth[4]+(real_orig_dth[9]*a*a)/pow(a*a-2*r+r*r,2)-(2*real_orig_dth[3]*a*(-a*a-r*r))/pow(a*a-2*r+r*r,2)+(real_orig_dth[0]*pow(-a*a-r*r,2))/pow(a*a-2*r+r*r,2)-(2*real_orig_dth[6]*a)/(a*a-2*r+r*r)+(2*real_orig_dth[1]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*r/(-sinth*sinth*sinth);
real_conv_dz[5] = factor*((real_orig[5]-(real_orig[8]*a)/(a*a-2*r+r*r)+(real_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[5]-(imag_orig[8]*a)/(a*a-2*r+r*r)+(imag_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*((-1 + m)*(-z))/(sinth*sinth*sinth) + factor*((real_orig_dth[5]-(real_orig_dth[8]*a)/(a*a-2*r+r*r)+(real_orig_dth[2]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig_dth[5]-(imag_orig_dth[8]*a)/(a*a-2*r+r*r)+(imag_orig_dth[2]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)/(sinth*sinth);
imag_conv_dz[5] = factor*((imag_orig[5]-(imag_orig[8]*a)/(a*a-2*r+r*r)+(imag_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[5]-(real_orig[8]*a)/(a*a-2*r+r*r)+(real_orig[2]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*((-1 + m)*(-z))/(sinth*sinth*sinth) + factor*((imag_orig_dth[5]-(imag_orig_dth[8]*a)/(a*a-2*r+r*r)+(imag_orig_dth[2]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig_dth[5]-(real_orig_dth[8]*a)/(a*a-2*r+r*r)+(real_orig_dth[2]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)/(sinth*sinth);
real_conv_dz[6] = factor*((real_orig[6]-(real_orig[9]*a)/(a*a-2*r+r*r)+(real_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig[6]-(imag_orig[9]*a)/(a*a-2*r+r*r)+(imag_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(m*z)/(sinth*sinth*sinth*sinth) + factor*((real_orig_dth[6]-(real_orig_dth[9]*a)/(a*a-2*r+r*r)+(real_orig_dth[3]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi+(imag_orig_dth[6]-(imag_orig_dth[9]*a)/(a*a-2*r+r*r)+(imag_orig_dth[3]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)/(-sinth*sinth*sinth);
imag_conv_dz[6] = factor*((imag_orig[6]-(imag_orig[9]*a)/(a*a-2*r+r*r)+(imag_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig[6]-(real_orig[9]*a)/(a*a-2*r+r*r)+(real_orig[3]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)*(m*z)/(sinth*sinth*sinth*sinth) + factor*((imag_orig_dth[6]-(imag_orig_dth[9]*a)/(a*a-2*r+r*r)+(imag_orig_dth[3]*(-a*a-r*r))/(a*a-2*r+r*r))*cosmdphi-(real_orig_dth[6]-(real_orig_dth[9]*a)/(a*a-2*r+r*r)+(real_orig_dth[3]*(-a*a-r*r))/(a*a-2*r+r*r))*sinmdphi)/(-sinth*sinth*sinth);
real_conv_dz[7] = factor*(real_orig[7]*cosmdphi+imag_orig[7]*sinmdphi)*((-2 + m)*z)/(sinth*sinth*r) + factor*(real_orig_dth[7]*cosmdphi+imag_orig_dth[7]*sinmdphi)/(-sinth*r);
imag_conv_dz[7] = factor*(imag_orig[7]*cosmdphi-real_orig[7]*sinmdphi)*((-2 + m)*z)/(sinth*sinth*r) + factor*(imag_orig_dth[7]*cosmdphi-real_orig_dth[7]*sinmdphi)/(-sinth*r);
real_conv_dz[8] = factor*(real_orig[8]*cosmdphi+imag_orig[8]*sinmdphi)*((1-m)*z)/(r*(sinth*sinth*sinth)) + factor*(real_orig_dth[8]*cosmdphi+imag_orig_dth[8]*sinmdphi)/(sinth*sinth*r);
imag_conv_dz[8] = factor*(imag_orig[8]*cosmdphi-real_orig[8]*sinmdphi)*((1-m)*z)/(r*(sinth*sinth*sinth)) + factor*(imag_orig_dth[8]*cosmdphi-real_orig_dth[8]*sinmdphi)/(sinth*sinth*r);
real_conv_dz[9] = factor*(real_orig[9]*cosmdphi+imag_orig[9]*sinmdphi)*(m*z)/(sinth*sinth*sinth*sinth*r) + factor*(real_orig_dth[9]*cosmdphi+imag_orig_dth[9]*sinmdphi)/(-sinth*sinth*sinth*r);
imag_conv_dz[9] = factor*(imag_orig[9]*cosmdphi-real_orig[9]*sinmdphi)*(m*z)/(sinth*sinth*sinth*sinth*r) + factor*(imag_orig_dth[9]*cosmdphi-real_orig_dth[9]*sinmdphi)/(-sinth*sinth*sinth*r);
}
}

void convert_effsource_dpsidr_vrz(int m, double a, double r, double z, std::array<double, 10>& real_orig, std::array<double, 10>& imag_orig, std::array<double, 10>& real_orig_dr, std::array<double, 10>& imag_orig_dr, std::array<double, 10>& real_conv_dr, std::array<double, 10>& imag_conv_dr){
double sinth = sqrt(1-z*z);
double rplus = 1+sqrt(1-a*a);
double rminus = 1-sqrt(1-a*a);
double mdphi = m*a/(rplus-rminus)*log((r-rplus)/(r-rminus));
...
real_conv_dr[1]=-((factor*(cosmdphi*(a*a+(-2+r)*r)*(real_orig[3]*a-real_orig[1]*(a*a+(-2+r)*r)+real_orig[0]*(a*a+r*r))+(a*a+(-2+r)*r)*(imag_orig[3]*a-imag_orig[1]*(a*a+(-2+r)*r)+imag_orig[0]*(a*a+r*r))*sinmdphi+r*(mdphi_dr*cosmdphi*(a*a+(-2+r)*r)*(imag_orig[3]*a-imag_orig[1]*(a*a+(-2+r)*r)+imag_orig[0]*(a*a+r*r))+cosmdphi*(-2*real_orig[3]*a*(-1+r)+real_orig_dr[3]*a*(a*a+(-2+r)*r)+2*real_orig[0]*r*(a*a+(-2+r)*r)-real_orig_dr[1]*pow(a*a+(-2+r)*r,2)-2*real_orig[0]*(-1+r)*(a*a+r*r)+real_orig_dr[0]*(a*a+(-2+r)*r)*(a*a+r*r))-mdphi_dr*(a*a+(-2+r)*r)*(real_orig[3]*a-real_orig[1]*(a*a+(-2+r)*r)+real_orig[0]*(a*a+r*r))*sinmdphi+(-2*imag_orig[3]*a*(-1+r)+imag_orig_dr[3]*a*(a*a+(-2+r)*r)+2*imag_orig[0]*r*(a*a+(-2+r)*r)-imag_orig_dr[1]*pow(a*a+(-2+r)*r,2)-2*imag_orig[0]*(-1+r)*(a*a+r*r)+imag_orig_dr[0]*(a*a+(-2+r)*r)*(a*a+r*r))*sinmdphi)))/pow(a*a+(-2+r)*r,2));
imag_conv_dr[1]=(factor*(-(cosmdphi*(a*a+(-2+r)*r)*(imag_orig[3]*a-imag_orig[1]*(a*a+(-2+r)*r)+imag_orig[0]*(a*a+r*r)))+(a*a+(-2+r)*r)*(real_orig[3]*a-real_orig[1]*(a*a+(-2+r)*r)+real_orig[0]*(a*a+r*r))*sinmdphi+r*(mdphi_dr*cosmdphi*(a*a+(-2+r)*r)*(real_orig[3]*a-real_orig[1]*(a*a+(-2+r)*r)+real_orig[0]*(a*a+r*r))-cosmdphi*(-2*imag_orig[3]*a*(-1+r)+imag_orig_dr[3]*a*(a*a+(-2+r)*r)+2*imag_orig[0]*r*(a*a+(-2+r)*r)-imag_orig_dr[1]*pow(a*a+(-2+r)*r,2)-2*imag_orig[0]*(-1+r)*(a*a+r*r)+imag_orig_dr[0]*(a*a+(-2+r)*r)*(a*a+r*r))+mdphi_dr*(a*a+(-2+r)*r)*(imag_orig[3]*a-imag_orig[1]*(a*a+(-2+r)*r)+imag_orig[0]*(a*a+r*r))*sinmdphi+(-2*real_orig[3]*a*(-1+r)+real_orig_dr[3]*a*(a*a+(-2+r)*r)+2*real_orig[0]*r*(a*a+(-2+r)*r)-real_orig_dr[1]*pow(a*a+(-2+r)*r,2)-2*real_orig[0]*(-1+r)*(a*a+r*r)+real_orig_dr[0]*(a*a+(-2+r)*r)*(a*a+r*r))*sinmdphi)))/pow(a*a+(-2+r)*r,2);
real_conv_dr[2]=-((factor*(real_orig_dr[2]*cosmdphi+imag_orig_dr[2]*sinmdphi+mdphi_dr*(imag_orig[2]*cosmdphi-real_orig[2]*sinmdphi)))/sinth);
imag_conv_dr[2]=(factor*(-(imag_orig_dr[2]*cosmdphi)+real_orig_dr[2]*sinmdphi+mdphi_dr*(real_orig[2]*cosmdphi+imag_orig[2]*sinmdphi)))/sinth;
real_conv_dr[3]=(factor*(real_orig_dr[3]*cosmdphi+imag_orig_dr[3]*sinmdphi+mdphi_dr*(imag_orig[3]*cosmdphi-real_orig[3]*sinmdphi)))/(sinth*sinth);
imag_conv_dr[3]=-((factor*(-(imag_orig_dr[3]*cosmdphi)+real_orig_dr[3]*sinmdphi+mdphi_dr*(real_orig[3]*cosmdphi+imag_orig[3]*sinmdphi)))/(sinth*sinth));
real_conv_dr[4]=(factor*(cosmdphi*(a*a+(-2+r)*r)*(real_orig[9]*a*a-2*real_orig[6]*a*(a*a+(-2+r)*r)+real_orig[4]*pow(a*a+(-2+r)*r,2)+2*real_orig[3]*a*(a*a+r*r)-2*real_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+real_orig[0]*pow(a*a+r*r,2))+(a*a+(-2+r)*r)*(imag_orig[9]*a*a-2*imag_orig[6]*a*(a*a+(-2+r)*r)+imag_orig[4]*pow(a*a+(-2+r)*r,2)+2*imag_orig[3]*a*(a*a+r*r)-2*imag_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+imag_orig[0]*pow(a*a+r*r,2))*sinmdphi+r*(mdphi_dr*cosmdphi*(a*a+(-2+r)*r)*(imag_orig[9]*a*a-2*imag_orig[6]*a*(a*a+(-2+r)*r)+imag_orig[4]*pow(a*a+(-2+r)*r,2)+2*imag_orig[3]*a*(a*a+r*r)-2*imag_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+imag_orig[0]*pow(a*a+r*r,2))+cosmdphi*(-4*real_orig[9]*a*a*(-1+r)+real_orig_dr[9]*a*a*(a*a+(-2+r)*r)+4*real_orig[6]*a*(-1+r)*(a*a+(-2+r)*r)+4*real_orig[3]*a*r*(a*a+(-2+r)*r)-2*real_orig_dr[6]*a*pow(a*a+(-2+r)*r,2)-4*real_orig[1]*r*pow(a*a+(-2+r)*r,2)+real_orig_dr[4]*pow(a*a+(-2+r)*r,3)-8*real_orig[3]*a*(-1+r)*(a*a+r*r)+2*real_orig_dr[3]*a*(a*a+(-2+r)*r)*(a*a+r*r)+4*real_orig[1]*(-1+r)*(a*a+(-2+r)*r)*(a*a+r*r)+4*real_orig[0]*r*(a*a+(-2+r)*r)*(a*a+r*r)-2*real_orig_dr[1]*pow(a*a+(-2+r)*r,2)*(a*a+r*r)-4*real_orig[0]*(-1+r)*pow(a*a+r*r,2)+real_orig_dr[0]*(a*a+(-2+r)*r)*pow(a*a+r*r,2))-mdphi_dr*(a*a+(-2+r)*r)*(real_orig[9]*a*a-2*real_orig[6]*a*(a*a+(-2+r)*r)+real_orig[4]*pow(a*a+(-2+r)*r,2)+2*real_orig[3]*a*(a*a+r*r)-2*real_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+real_orig[0]*pow(a*a+r*r,2))*sinmdphi+(-4*imag_orig[9]*a*a*(-1+r)+imag_orig_dr[9]*a*a*(a*a+(-2+r)*r)+4*imag_orig[6]*a*(-1+r)*(a*a+(-2+r)*r)+4*imag_orig[3]*a*r*(a*a+(-2+r)*r)-2*imag_orig_dr[6]*a*pow(a*a+(-2+r)*r,2)-4*imag_orig[1]*r*pow(a*a+(-2+r)*r,2)+imag_orig_dr[4]*pow(a*a+(-2+r)*r,3)-8*imag_orig[3]*a*(-1+r)*(a*a+r*r)+2*imag_orig_dr[3]*a*(a*a+(-2+r)*r)*(a*a+r*r)+4*imag_orig[1]*(-1+r)*(a*a+(-2+r)*r)*(a*a+r*r)+4*imag_orig[0]*r*(a*a+(-2+r)*r)*(a*a+r*r)-2*imag_orig_dr[1]*pow(a*a+(-2+r)*r,2)*(a*a+r*r)-4*imag_orig[0]*(-1+r)*pow(a*a+r*r,2)+imag_orig_dr[0]*(a*a+(-2+r)*r)*pow(a*a+r*r,2))*sinmdphi)))/pow(a*a+(-2+r)*r,3);
imag_conv_dr[4]=(factor*(cosmdphi*(a*a+(-2+r)*r)*(imag_orig[9]*a*a-2*imag_orig[6]*a*(a*a+(-2+r)*r)+imag_orig[4]*pow(a*a+(-2+r)*r,2)+2*imag_orig[3]*a*(a*a+r*r)-2*imag_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+imag_orig[0]*pow(a*a+r*r,2))-(a*a+(-2+r)*r)*(real_orig[9]*a*a-2*real_orig[6]*a*(a*a+(-2+r)*r)+real_orig[4]*pow(a*a+(-2+r)*r,2)+2*real_orig[3]*a*(a*a+r*r)-2*real_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+real_orig[0]*pow(a*a+r*r,2))*sinmdphi-r*(mdphi_dr*cosmdphi*(a*a+(-2+r)*r)*(real_orig[9]*a*a-2*real_orig[6]*a*(a*a+(-2+r)*r)+real_orig[4]*pow(a*a+(-2+r)*r,2)+2*real_orig[3]*a*(a*a+r*r)-2*real_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+real_orig[0]*pow(a*a+r*r,2))-cosmdphi*(-4*imag_orig[9]*a*a*(-1+r)+imag_orig_dr[9]*a*a*(a*a+(-2+r)*r)+4*imag_orig[6]*a*(-1+r)*(a*a+(-2+r)*r)+4*imag_orig[3]*a*r*(a*a+(-2+r)*r)-2*imag_orig_dr[6]*a*pow(a*a+(-2+r)*r,2)-4*imag_orig[1]*r*pow(a*a+(-2+r)*r,2)+imag_orig_dr[4]*pow(a*a+(-2+r)*r,3)-8*imag_orig[3]*a*(-1+r)*(a*a+r*r)+2*imag_orig_dr[3]*a*(a*a+(-2+r)*r)*(a*a+r*r)+4*imag_orig[1]*(-1+r)*(a*a+(-2+r)*r)*(a*a+r*r)+4*imag_orig[0]*r*(a*a+(-2+r)*r)*(a*a+r*r)-2*imag_orig_dr[1]*pow(a*a+(-2+r)*r,2)*(a*a+r*r)-4*imag_orig[0]*(-1+r)*pow(a*a+r*r,2)+imag_orig_dr[0]*(a*a+(-2+r)*r)*pow(a*a+r*r,2))+mdphi_dr*(a*a+(-2+r)*r)*(imag_orig[9]*a*a-2*imag_orig[6]*a*(a*a+(-2+r)*r)+imag_orig[4]*pow(a*a+(-2+r)*r,2)+2*imag_orig[3]*a*(a*a+r*r)-2*imag_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+imag_orig[0]*pow(a*a+r*r,2))*sinmdphi+(-4*real_orig[9]*a*a*(-1+r)+real_orig_dr[9]*a*a*(a*a+(-2+r)*r)+4*real_orig[6]*a*(-1+r)*(a*a+(-2+r)*r)+4*real_orig[3]*a*r*(a*a+(-2+r)*r)-2*real_orig_dr[6]*a*pow(a*a+(-2+r)*r,2)-4*real_orig[1]*r*pow(a*a+(-2+r)*r,2)+real_orig_dr[4]*pow(a*a+(-2+r)*r,3)-8*real_orig[3]*a*(-1+r)*(a*a+r*r)+2*real_orig_dr[3]*a*(a*a+(-2+r)*r)*(a*a+r*r)+4*real_orig[1]*(-1+r)*(a*a+(-2+r)*r)*(a*a+r*r)+4*real_orig[0]*r*(a*a+(-2+r)*r)*(a*a+r*r)-2*real_orig_dr[1]*pow(a*a+(-2+r)*r,2)*(a*a+r*r)-4*real_orig[0]*(-1+r)*pow(a*a+r*r,2)+real_orig_dr[0]*(a*a+(-2+r)*r)*pow(a*a+r*r,2))*sinmdphi)))/pow(a*a+(-2+r)*r,3);
real_conv_dr[5]=(factor*(mdphi_dr*cosmdphi*(a*a+(-2+r)*r)*(imag_orig[8]*a-imag_orig[5]*(a*a+(-2+r)*r)+imag_orig[2]*(a*a+r*r))+cosmdphi*(-2*real_orig[8]*a*(-1+r)+real_orig_dr[8]*a*(a*a+(-2+r)*r)+2*real_orig[2]*r*(a*a+(-2+r)*r)-real_orig_dr[5]*pow(a*a+(-2+r)*r,2)-2*real_orig[2]*(-1+r)*(a*a+r*r)+real_orig_dr[2]*(a*a+(-2+r)*r)*(a*a+r*r))-mdphi_dr*(a*a+(-2+r)*r)*(real_orig[8]*a-real_orig[5]*(a*a+(-2+r)*r)+real_orig[2]*(a*a+r*r))*sinmdphi+(-2*imag_orig[8]*a*(-1+r)+imag_orig_dr[8]*a*(a*a+(-2+r)*r)+2*imag_orig[2]*r*(a*a+(-2+r)*r)-imag_orig_dr[5]*pow(a*a+(-2+r)*r,2)-2*imag_orig[2]*(-1+r)*(a*a+r*r)+imag_orig_dr[2]*(a*a+(-2+r)*r)*(a*a+r*r))*sinmdphi))/(pow(a*a+(-2+r)*r,2)*sinth);
imag_conv_dr[5]=-((factor*(mdphi_dr*cosmdphi*(a*a+(-2+r)*r)*(real_orig[8]*a-real_orig[5]*(a*a+(-2+r)*r)+real_orig[2]*(a*a+r*r))-cosmdphi*(-2*imag_orig[8]*a*(-1+r)+imag_orig_dr[8]*a*(a*a+(-2+r)*r)+2*imag_orig[2]*r*(a*a+(-2+r)*r)-imag_orig_dr[5]*pow(a*a+(-2+r)*r,2)-2*imag_orig[2]*(-1+r)*(a*a+r*r)+imag_orig_dr[2]*(a*a+(-2+r)*r)*(a*a+r*r))+mdphi_dr*(a*a+(-2+r)*r)*(imag_orig[8]*a-imag_orig[5]*(a*a+(-2+r)*r)+imag_orig[2]*(a*a+r*r))*sinmdphi+(-2*real_orig[8]*a*(-1+r)+real_orig_dr[8]*a*(a*a+(-2+r)*r)+2*real_orig[2]*r*(a*a+(-2+r)*r)-real_orig_dr[5]*pow(a*a+(-2+r)*r,2)-2*real_orig[2]*(-1+r)*(a*a+r*r)+real_orig_dr[2]*(a*a+(-2+r)*r)*(a*a+r*r))*sinmdphi))/(pow(a*a+(-2+r)*r,2)*sinth));
...
factor = 1.0/(2*M_PI);
real_conv_dr[0]=(factor*(cosmdphi*(real_orig[0]+real_orig_dr[0]*r)+(imag_orig[0]+imag_orig_dr[0]*r)*sinmdphi+mdphi_dr*r*(imag_orig[0]*cosmdphi-real_orig[0]*sinmdphi)))/sinth;
imag_conv_dr[0]=-((factor*(-(cosmdphi*(imag_orig[0]+imag_orig_dr[0]*r))+(real_orig[0]+real_orig_dr[0]*r)*sinmdphi+mdphi_dr*r*(real_orig[0]*cosmdphi+imag_orig[0]*sinmdphi)))/sinth);
real_conv_dr[1]=-((factor*(cosmdphi*(a*a+(-2+r)*r)*(real_orig[3]*a-real_orig[1]*(a*a+(-2+r)*r)+real_orig[0]*(a*a+r*r))+(a*a+(-2+r)*r)*(imag_orig[3]*a-imag_orig[1]*(a*a+(-2+r)*r)+imag_orig[0]*(a*a+r*r))*sinmdphi+r*(mdphi_dr*cosmdphi*(a*a+(-2+r)*r)*(imag_orig[3]*a-imag_orig[1]*(a*a+(-2+r)*r)+imag_orig[0]*(a*a+r*r))+cosmdphi*(-2*real_orig[3]*a*(-1+r)+real_orig_dr[3]*a*(a*a+(-2+r)*r)+2*real_orig[0]*r*(a*a+(-2+r)*r)-real_orig_dr[1]*pow(a*a+(-2+r)*r,2)-2*real_orig[0]*(-1+r)*(a*a+r*r)+real_orig_dr[0]*(a*a+(-2+r)*r)*(a*a+r*r))-mdphi_dr*(a*a+(-2+r)*r)*(real_orig[3]*a-real_orig[1]*(a*a+(-2+r)*r)+real_orig[0]*(a*a+r*r))*sinmdphi+(-2*imag_orig[3]*a*(-1+r)+imag_orig_dr[3]*a*(a*a+(-2+r)*r)+2*imag_orig[0]*r*(a*a+(-2+r)*r)-imag_orig_dr[1]*pow(a*a+(-2+r)*r,2)-2*imag_orig[0]*(-1+r)*(a*a+r*r)+imag_orig_dr[0]*(a*a+(-2+r)*r)*(a*a+r*r))*sinmdphi)))/(pow(a*a+(-2+r)*r,2)*sinth));
imag_conv_dr[1]=(factor*(-(cosmdphi*(a*a+(-2+r)*r)*(imag_orig[3]*a-imag_orig[1]*(a*a+(-2+r)*r)+imag_orig[0]*(a*a+r*r)))+(a*a+(-2+r)*r)*(real_orig[3]*a-real_orig[1]*(a*a+(-2+r)*r)+real_orig[0]*(a*a+r*r))*sinmdphi+r*(mdphi_dr*cosmdphi*(a*a+(-2+r)*r)*(real_orig[3]*a-real_orig[1]*(a*a+(-2+r)*r)+real_orig[0]*(a*a+r*r))-cosmdphi*(-2*imag_orig[3]*a*(-1+r)+imag_orig_dr[3]*a*(a*a+(-2+r)*r)+2*imag_orig[0]*r*(a*a+(-2+r)*r)-imag_orig_dr[1]*pow(a*a+(-2+r)*r,2)-2*imag_orig[0]*(-1+r)*(a*a+r*r)+imag_orig_dr[0]*(a*a+(-2+r)*r)*(a*a+r*r))+mdphi_dr*(a*a+(-2+r)*r)*(imag_orig[3]*a-imag_orig[1]*(a*a+(-2+r)*r)+imag_orig[0]*(a*a+r*r))*sinmdphi+(-2*real_orig[3]*a*(-1+r)+real_orig_dr[3]*a*(a*a+(-2+r)*r)+2*real_orig[0]*r*(a*a+(-2+r)*r)-real_orig_dr[1]*pow(a*a+(-2+r)*r,2)-2*real_orig[0]*(-1+r)*(a*a+r*r)+real_orig_dr[0]*(a*a+(-2+r)*r)*(a*a+r*r))*sinmdphi)))/(pow(a*a+(-2+r)*r,2)*sinth);
real_conv_dr[2]=-(factor*(real_orig_dr[2]*cosmdphi+imag_orig_dr[2]*sinmdphi+mdphi_dr*(imag_orig[2]*cosmdphi-real_orig[2]*sinmdphi)));
imag_conv_dr[2]=factor*(-(imag_orig_dr[2]*cosmdphi)+real_orig_dr[2]*sinmdphi+mdphi_dr*(real_orig[2]*cosmdphi+imag_orig[2]*sinmdphi));
real_conv_dr[3]=(factor*(real_orig_dr[3]*cosmdphi+imag_orig_dr[3]*sinmdphi+mdphi_dr*(imag_orig[3]*cosmdphi-real_orig[3]*sinmdphi)))/sinth;
imag_conv_dr[3]=-((factor*(-(imag_orig_dr[3]*cosmdphi)+real_orig_dr[3]*sinmdphi+mdphi_dr*(real_orig[3]*cosmdphi+imag_orig[3]*sinmdphi)))/sinth);
real_conv_dr[4]=(factor*(cosmdphi*(a*a+(-2+r)*r)*(real_orig[9]*a*a-2*real_orig[6]*a*(a*a+(-2+r)*r)+real_orig[4]*pow(a*a+(-2+r)*r,2)+2*real_orig[3]*a*(a*a+r*r)-2*real_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+real_orig[0]*pow(a*a+r*r,2))+(a*a+(-2+r)*r)*(imag_orig[9]*a*a-2*imag_orig[6]*a*(a*a+(-2+r)*r)+imag_orig[4]*pow(a*a+(-2+r)*r,2)+2*imag_orig[3]*a*(a*a+r*r)-2*imag_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+imag_orig[0]*pow(a*a+r*r,2))*sinmdphi+r*(mdphi_dr*cosmdphi*(a*a+(-2+r)*r)*(imag_orig[9]*a*a-2*imag_orig[6]*a*(a*a+(-2+r)*r)+imag_orig[4]*pow(a*a+(-2+r)*r,2)+2*imag_orig[3]*a*(a*a+r*r)-2*imag_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+imag_orig[0]*pow(a*a+r*r,2))+cosmdphi*(-4*real_orig[9]*a*a*(-1+r)+real_orig_dr[9]*a*a*(a*a+(-2+r)*r)+4*real_orig[6]*a*(-1+r)*(a*a+(-2+r)*r)+4*real_orig[3]*a*r*(a*a+(-2+r)*r)-2*real_orig_dr[6]*a*pow(a*a+(-2+r)*r,2)-4*real_orig[1]*r*pow(a*a+(-2+r)*r,2)+real_orig_dr[4]*pow(a*a+(-2+r)*r,3)-8*real_orig[3]*a*(-1+r)*(a*a+r*r)+2*real_orig_dr[3]*a*(a*a+(-2+r)*r)*(a*a+r*r)+4*real_orig[1]*(-1+r)*(a*a+(-2+r)*r)*(a*a+r*r)+4*real_orig[0]*r*(a*a+(-2+r)*r)*(a*a+r*r)-2*real_orig_dr[1]*pow(a*a+(-2+r)*r,2)*(a*a+r*r)-4*real_orig[0]*(-1+r)*pow(a*a+r*r,2)+real_orig_dr[0]*(a*a+(-2+r)*r)*pow(a*a+r*r,2))-mdphi_dr*(a*a+(-2+r)*r)*(real_orig[9]*a*a-2*real_orig[6]*a*(a*a+(-2+r)*r)+real_orig[4]*pow(a*a+(-2+r)*r,2)+2*real_orig[3]*a*(a*a+r*r)-2*real_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+real_orig[0]*pow(a*a+r*r,2))*sinmdphi+(-4*imag_orig[9]*a*a*(-1+r)+imag_orig_dr[9]*a*a*(a*a+(-2+r)*r)+4*imag_orig[6]*a*(-1+r)*(a*a+(-2+r)*r)+4*imag_orig[3]*a*r*(a*a+(-2+r)*r)-2*imag_orig_dr[6]*a*pow(a*a+(-2+r)*r,2)-4*imag_orig[1]*r*pow(a*a+(-2+r)*r,2)+imag_orig_dr[4]*pow(a*a+(-2+r)*r,3)-8*imag_orig[3]*a*(-1+r)*(a*a+r*r)+2*imag_orig_dr[3]*a*(a*a+(-2+r)*r)*(a*a+r*r)+4*imag_orig[1]*(-1+r)*(a*a+(-2+r)*r)*(a*a+r*r)+4*imag_orig[0]*r*(a*a+(-2+r)*r)*(a*a+r*r)-2*imag_orig_dr[1]*pow(a*a+(-2+r)*r,2)*(a*a+r*r)-4*imag_orig[0]*(-1+r)*pow(a*a+r*r,2)+imag_orig_dr[0]*(a*a+(-2+r)*r)*pow(a*a+r*r,2))*sinmdphi)))/(pow(a*a+(-2+r)*r,3)*sinth);
imag_conv_dr[4]=(factor*(cosmdphi*(a*a+(-2+r)*r)*(imag_orig[9]*a*a-2*imag_orig[6]*a*(a*a+(-2+r)*r)+imag_orig[4]*pow(a*a+(-2+r)*r,2)+2*imag_orig[3]*a*(a*a+r*r)-2*imag_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+imag_orig[0]*pow(a*a+r*r,2))-(a*a+(-2+r)*r)*(real_orig[9]*a*a-2*real_orig[6]*a*(a*a+(-2+r)*r)+real_orig[4]*pow(a*a+(-2+r)*r,2)+2*real_orig[3]*a*(a*a+r*r)-2*real_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+real_orig[0]*pow(a*a+r*r,2))*sinmdphi-r*(mdphi_dr*cosmdphi*(a*a+(-2+r)*r)*(real_orig[9]*a*a-2*real_orig[6]*a*(a*a+(-2+r)*r)+real_orig[4]*pow(a*a+(-2+r)*r,2)+2*real_orig[3]*a*(a*a+r*r)-2*real_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+real_orig[0]*pow(a*a+r*r,2))-cosmdphi*(-4*imag_orig[9]*a*a*(-1+r)+imag_orig_dr[9]*a*a*(a*a+(-2+r)*r)+4*imag_orig[6]*a*(-1+r)*(a*a+(-2+r)*r)+4*imag_orig[3]*a*r*(a*a+(-2+r)*r)-2*imag_orig_dr[6]*a*pow(a*a+(-2+r)*r,2)-4*imag_orig[1]*r*pow(a*a+(-2+r)*r,2)+imag_orig_dr[4]*pow(a*a+(-2+r)*r,3)-8*imag_orig[3]*a*(-1+r)*(a*a+r*r)+2*imag_orig_dr[3]*a*(a*a+(-2+r)*r)*(a*a+r*r)+4*imag_orig[1]*(-1+r)*(a*a+(-2+r)*r)*(a*a+r*r)+4*imag_orig[0]*r*(a*a+(-2+r)*r)*(a*a+r*r)-2*imag_orig_dr[1]*pow(a*a+(-2+r)*r,2)*(a*a+r*r)-4*imag_orig[0]*(-1+r)*pow(a*a+r*r,2)+imag_orig_dr[0]*(a*a+(-2+r)*r)*pow(a*a+r*r,2))+mdphi_dr*(a*a+(-2+r)*r)*(imag_orig[9]*a*a-2*imag_orig[6]*a*(a*a+(-2+r)*r)+imag_orig[4]*pow(a*a+(-2+r)*r,2)+2*imag_orig[3]*a*(a*a+r*r)-2*imag_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+imag_orig[0]*pow(a*a+r*r,2))*sinmdphi+(-4*real_orig[9]*a*a*(-1+r)+real_orig_dr[9]*a*a*(a*a+(-2+r)*r)+4*real_orig[6]*a*(-1+r)*(a*a+(-2+r)*r)+4*real_orig[3]*a*r*(a*a+(-2+r)*r)-2*real_orig_dr[6]*a*pow(a*a+(-2+r)*r,2)-4*real_orig[1]*r*pow(a*a+(-2+r)*r,2)+real_orig_dr[4]*pow(a*a+(-2+r)*r,3)-8*real_orig[3]*a*(-1+r)*(a*a+r*r)+2*real_orig_dr[3]*a*(a*a+(-2+r)*r)*(a*a+r*r)+4*real_orig[1]*(-1+r)*(a*a+(-2+r)*r)*(a*a+r*r)+4*real_orig[0]*r*(a*a+(-2+r)*r)*(a*a+r*r)-2*real_orig_dr[1]*pow(a*a+(-2+r)*r,2)*(a*a+r*r)-4*real_orig[0]*(-1+r)*pow(a*a+r*r,2)+real_orig_dr[0]*(a*a+(-2+r)*r)*pow(a*a+r*r,2))*sinmdphi)))/(pow(a*a+(-2+r)*r,3)*sinth);
real_conv_dr[5]=(factor*(mdphi_dr*cosmdphi*(a*a+(-2+r)*r)*(imag_orig[8]*a-imag_orig[5]*(a*a+(-2+r)*r)+imag_orig[2]*(a*a+r*r))+cosmdphi*(-2*real_orig[8]*a*(-1+r)+real_orig_dr[8]*a*(a*a+(-2+r)*r)+2*real_orig[2]*r*(a*a+(-2+r)*r)-real_orig_dr[5]*pow(a*a+(-2+r)*r,2)-2*real_orig[2]*(-1+r)*(a*a+r*r)+real_orig_dr[2]*(a*a+(-2+r)*r)*(a*a+r*r))-mdphi_dr*(a*a+(-2+r)*r)*(real_orig[8]*a-real_orig[5]*(a*a+(-2+r)*r)+real_orig[2]*(a*a+r*r))*sinmdphi+(-2*imag_orig[8]*a*(-1+r)+imag_orig_dr[8]*a*(a*a+(-2+r)*r)+2*imag_orig[2]*r*(a*a+(-2+r)*r)-imag_orig_dr[5]*pow(a*a+(-2+r)*r,2)-2*imag_orig[2]*(-1+r)*(a*a+r*r)+imag_orig_dr[2]*(a*a+(-2+r)*r)*(a*a+r*r))*sinmdphi))/pow(a*a+(-2+r)*r,2);
imag_conv_dr[5]=-((factor*(mdphi_dr*cosmdphi*(a*a+(-2+r)*r)*(real_orig[8]*a-real_orig[5]*(a*a+(-2+r)*r)+real_orig[2]*(a*a+r*r))-cosmdphi*(-2*imag_orig[8]*a*(-1+r)+imag_orig_dr[8]*a*(a*a+(-2+r)*r)+2*imag_orig[2]*r*(a*a+(-2+r)*r)-imag_orig_dr[5]*pow(a*a+(-2+r)*r,2)-2*imag_orig[2]*(-1+r)*(a*a+r*r)+imag_orig_dr[2]*(a*a+(-2+r)*r)*(a*a+r*r))+mdphi_dr*(a*a+(-2+r)*r)*(imag_orig[8]*a-imag_orig[5]*(a*a+(-2+r)*r)+imag_orig[2]*(a*a+r*r))*sinmdphi+(-2*real_orig[8]*a*(-1+r)+real_orig_dr[8]*a*(a*a+(-2+r)*r)+2*real_orig[2]*r*(a*a+(-2+r)*r)-real_orig_dr[5]*pow(a*a+(-2+r)*r,2)-2*real_orig[2]*(-1+r)*(a*a+r*r)+real_orig_dr[2]*(a*a+(-2+r)*r)*(a*a+r*r))*sinmdphi))/pow(a*a+(-2+r)*r,2));
real_conv_dr[6]=-((factor*(mdphi_dr*cosmdphi*(a*a+(-2+r)*r)*(imag_orig[9]*a-imag_orig[6]*(a*a+(-2+r)*r)+imag_orig[3]*(a*a+r*r))+cosmdphi*(-2*real_orig[9]*a*(-1+r)+real_orig_dr[9]*a*(a*a+(-2+r)*r)+2*real_orig[3]*r*(a*a+(-2+r)*r)-real_orig_dr[6]*pow(a*a+(-2+r)*r,2)-2*real_orig[3]*(-1+r)*(a*a+r*r)+real_orig_dr[3]*(a*a+(-2+r)*r)*(a*a+r*r))-mdphi_dr*(a*a+(-2+r)*r)*(real_orig[9]*a-real_orig[6]*(a*a+(-2+r)*r)+real_orig[3]*(a*a+r*r))*sinmdphi+(-2*imag_orig[9]*a*(-1+r)+imag_orig_dr[9]*a*(a*a+(-2+r)*r)+2*imag_orig[3]*r*(a*a+(-2+r)*r)-imag_orig_dr[6]*pow(a*a+(-2+r)*r,2)-2*imag_orig[3]*(-1+r)*(a*a+r*r)+imag_orig_dr[3]*(a*a+(-2+r)*r)*(a*a+r*r))*sinmdphi))/(pow(a*a+(-2+r)*r,2)*sinth));
imag_conv_dr[6]=(factor*(mdphi_dr*cosmdphi*(a*a+(-2+r)*r)*(real_orig[9]*a-real_orig[6]*(a*a+(-2+r)*r)+real_orig[3]*(a*a+r*r))-cosmdphi*(-2*imag_orig[9]*a*(-1+r)+imag_orig_dr[9]*a*(a*a+(-2+r)*r)+2*imag_orig[3]*r*(a*a+(-2+r)*r)-imag_orig_dr[6]*pow(a*a+(-2+r)*r,2)-2*imag_orig[3]*(-1+r)*(a*a+r*r)+imag_orig_dr[3]*(a*a+(-2+r)*r)*(a*a+r*r))+mdphi_dr*(a*a+(-2+r)*r)*(imag_orig[9]*a-imag_orig[6]*(a*a+(-2+r)*r)+imag_orig[3]*(a*a+r*r))*sinmdphi+(-2*real_orig[9]*a*(-1+r)+real_orig_dr[9]*a*(a*a+(-2+r)*r)+2*real_orig[3]*r*(a*a+(-2+r)*r)-real_orig_dr[6]*pow(a*a+(-2+r)*r,2)-2*real_orig[3]*(-1+r)*(a*a+r*r)+real_orig_dr[3]*(a*a+(-2+r)*r)*(a*a+r*r))*sinmdphi))/(pow(a*a+(-2+r)*r,2)*sinth);
real_conv_dr[7]=(factor*(cosmdphi*(-real_orig[7]+real_orig_dr[7]*r)+(-imag_orig[7]+imag_orig_dr[7]*r)*sinmdphi+mdphi_dr*r*(imag_orig[7]*cosmdphi-real_orig[7]*sinmdphi)))/(r*r*sinth);
imag_conv_dr[7]=-((factor*(cosmdphi*(imag_orig[7]-imag_orig_dr[7]*r)+(-real_orig[7]+real_orig_dr[7]*r)*sinmdphi+mdphi_dr*r*(real_orig[7]*cosmdphi+imag_orig[7]*sinmdphi)))/(r*r*sinth));
real_conv_dr[8]=(factor*(cosmdphi*(real_orig[8]-real_orig_dr[8]*r)+(imag_orig[8]-imag_orig_dr[8]*r)*sinmdphi+mdphi_dr*(-(imag_orig[8]*cosmdphi*r)+real_orig[8]*r*sinmdphi)))/(r*r*sinth*sinth);
imag_conv_dr[8]=(factor*(cosmdphi*(imag_orig[8]-imag_orig_dr[8]*r)+(-real_orig[8]+real_orig_dr[8]*r)*sinmdphi+mdphi_dr*r*(real_orig[8]*cosmdphi+imag_orig[8]*sinmdphi)))/(r*r*sinth*sinth);
real_conv_dr[9]=(factor*(cosmdphi*(-real_orig[9]+real_orig_dr[9]*r)+(-imag_orig[9]+imag_orig_dr[9]*r)*sinmdphi+mdphi_dr*r*(imag_orig[9]*cosmdphi-real_orig[9]*sinmdphi)))/(r*r*pow(sinth,3));
imag_conv_dr[9]=-((factor*(cosmdphi*(imag_orig[9]-imag_orig_dr[9]*r)+(-real_orig[9]+real_orig_dr[9]*r)*sinmdphi+mdphi_dr*r*(real_orig[9]*cosmdphi+imag_orig[9]*sinmdphi)))/(r*r*pow(sinth,3)));
} else {
factor = 1.0/(2*M_PI*pow(sinth,m-2));
real_conv_dr[0]=(factor*(cosmdphi*(real_orig[0]+real_orig_dr[0]*r)+(imag_orig[0]+imag_orig_dr[0]*r)*sinmdphi+mdphi_dr*r*(imag_orig[0]*cosmdphi-real_orig[0]*sinmdphi)))/(sinth*sinth);
imag_conv_dr[0]=-((factor*(-(cosmdphi*(imag_orig[0]+imag_orig_dr[0]*r))+(real_orig[0]+real_orig_dr[0]*r)*sinmdphi+mdphi_dr*r*(real_orig[0]*cosmdphi+imag_orig[0]*sinmdphi)))/(sinth*sinth));
real_conv_dr[1]=-((factor*(cosmdphi*(a*a+(-2+r)*r)*(real_orig[3]*a-real_orig[1]*(a*a+(-2+r)*r)+real_orig[0]*(a*a+r*r))+(a*a+(-2+r)*r)*(imag_orig[3]*a-imag_orig[1]*(a*a+(-2+r)*r)+imag_orig[0]*(a*a+r*r))*sinmdphi+r*(mdphi_dr*cosmdphi*(a*a+(-2+r)*r)*(imag_orig[3]*a-imag_orig[1]*(a*a+(-2+r)*r)+imag_orig[0]*(a*a+r*r))+cosmdphi*(-2*real_orig[3]*a*(-1+r)+real_orig_dr[3]*a*(a*a+(-2+r)*r)+2*real_orig[0]*r*(a*a+(-2+r)*r)-real_orig_dr[1]*pow(a*a+(-2+r)*r,2)-2*real_orig[0]*(-1+r)*(a*a+r*r)+real_orig_dr[0]*(a*a+(-2+r)*r)*(a*a+r*r))-mdphi_dr*(a*a+(-2+r)*r)*(real_orig[3]*a-real_orig[1]*(a*a+(-2+r)*r)+real_orig[0]*(a*a+r*r))*sinmdphi+(-2*imag_orig[3]*a*(-1+r)+imag_orig_dr[3]*a*(a*a+(-2+r)*r)+2*imag_orig[0]*r*(a*a+(-2+r)*r)-imag_orig_dr[1]*pow(a*a+(-2+r)*r,2)-2*imag_orig[0]*(-1+r)*(a*a+r*r)+imag_orig_dr[0]*(a*a+(-2+r)*r)*(a*a+r*r))*sinmdphi)))/(pow(a*a+(-2+r)*r,2)*sinth*sinth));
imag_conv_dr[1]=(factor*(-(cosmdphi*(a*a+(-2+r)*r)*(imag_orig[3]*a-imag_orig[1]*(a*a+(-2+r)*r)+imag_orig[0]*(a*a+r*r)))+(a*a+(-2+r)*r)*(real_orig[3]*a-real_orig[1]*(a*a+(-2+r)*r)+real_orig[0]*(a*a+r*r))*sinmdphi+r*(mdphi_dr*cosmdphi*(a*a+(-2+r)*r)*(real_orig[3]*a-real_orig[1]*(a*a+(-2+r)*r)+real_orig[0]*(a*a+r*r))-cosmdphi*(-2*imag_orig[3]*a*(-1+r)+imag_orig_dr[3]*a*(a*a+(-2+r)*r)+2*imag_orig[0]*r*(a*a+(-2+r)*r)-imag_orig_dr[1]*pow(a*a+(-2+r)*r,2)-2*imag_orig[0]*(-1+r)*(a*a+r*r)+imag_orig_dr[0]*(a*a+(-2+r)*r)*(a*a+r*r))+mdphi_dr*(a*a+(-2+r)*r)*(imag_orig[3]*a-imag_orig[1]*(a*a+(-2+r)*r)+imag_orig[0]*(a*a+r*r))*sinmdphi+(-2*real_orig[3]*a*(-1+r)+real_orig_dr[3]*a*(a*a+(-2+r)*r)+2*real_orig[0]*r*(a*a+(-2+r)*r)-real_orig_dr[1]*pow(a*a+(-2+r)*r,2)-2*real_orig[0]*(-1+r)*(a*a+r*r)+real_orig_dr[0]*(a*a+(-2+r)*r)*(a*a+r*r))*sinmdphi)))/(pow(a*a+(-2+r)*r,2)*sinth*sinth);
real_conv_dr[2]=-((factor*(real_orig_dr[2]*cosmdphi+imag_orig_dr[2]*sinmdphi+mdphi_dr*(imag_orig[2]*cosmdphi-real_orig[2]*sinmdphi)))/sinth);
imag_conv_dr[2]=(factor*(-(imag_orig_dr[2]*cosmdphi)+real_orig_dr[2]*sinmdphi+mdphi_dr*(real_orig[2]*cosmdphi+imag_orig[2]*sinmdphi)))/sinth;
real_conv_dr[3]=(factor*(real_orig_dr[3]*cosmdphi+imag_orig_dr[3]*sinmdphi+mdphi_dr*(imag_orig[3]*cosmdphi-real_orig[3]*sinmdphi)))/(sinth*sinth);
imag_conv_dr[3]=-((factor*(-(imag_orig_dr[3]*cosmdphi)+real_orig_dr[3]*sinmdphi+mdphi_dr*(real_orig[3]*cosmdphi+imag_orig[3]*sinmdphi)))/(sinth*sinth));
real_conv_dr[4]=(factor*(cosmdphi*(a*a+(-2+r)*r)*(real_orig[9]*a*a-2*real_orig[6]*a*(a*a+(-2+r)*r)+real_orig[4]*pow(a*a+(-2+r)*r,2)+2*real_orig[3]*a*(a*a+r*r)-2*real_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+real_orig[0]*pow(a*a+r*r,2))+(a*a+(-2+r)*r)*(imag_orig[9]*a*a-2*imag_orig[6]*a*(a*a+(-2+r)*r)+imag_orig[4]*pow(a*a+(-2+r)*r,2)+2*imag_orig[3]*a*(a*a+r*r)-2*imag_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+imag_orig[0]*pow(a*a+r*r,2))*sinmdphi+r*(mdphi_dr*cosmdphi*(a*a+(-2+r)*r)*(imag_orig[9]*a*a-2*imag_orig[6]*a*(a*a+(-2+r)*r)+imag_orig[4]*pow(a*a+(-2+r)*r,2)+2*imag_orig[3]*a*(a*a+r*r)-2*imag_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+imag_orig[0]*pow(a*a+r*r,2))+cosmdphi*(-4*real_orig[9]*a*a*(-1+r)+real_orig_dr[9]*a*a*(a*a+(-2+r)*r)+4*real_orig[6]*a*(-1+r)*(a*a+(-2+r)*r)+4*real_orig[3]*a*r*(a*a+(-2+r)*r)-2*real_orig_dr[6]*a*pow(a*a+(-2+r)*r,2)-4*real_orig[1]*r*pow(a*a+(-2+r)*r,2)+real_orig_dr[4]*pow(a*a+(-2+r)*r,3)-8*real_orig[3]*a*(-1+r)*(a*a+r*r)+2*real_orig_dr[3]*a*(a*a+(-2+r)*r)*(a*a+r*r)+4*real_orig[1]*(-1+r)*(a*a+(-2+r)*r)*(a*a+r*r)+4*real_orig[0]*r*(a*a+(-2+r)*r)*(a*a+r*r)-2*real_orig_dr[1]*pow(a*a+(-2+r)*r,2)*(a*a+r*r)-4*real_orig[0]*(-1+r)*pow(a*a+r*r,2)+real_orig_dr[0]*(a*a+(-2+r)*r)*pow(a*a+r*r,2))-mdphi_dr*(a*a+(-2+r)*r)*(real_orig[9]*a*a-2*real_orig[6]*a*(a*a+(-2+r)*r)+real_orig[4]*pow(a*a+(-2+r)*r,2)+2*real_orig[3]*a*(a*a+r*r)-2*real_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+real_orig[0]*pow(a*a+r*r,2))*sinmdphi+(-4*imag_orig[9]*a*a*(-1+r)+imag_orig_dr[9]*a*a*(a*a+(-2+r)*r)+4*imag_orig[6]*a*(-1+r)*(a*a+(-2+r)*r)+4*imag_orig[3]*a*r*(a*a+(-2+r)*r)-2*imag_orig_dr[6]*a*pow(a*a+(-2+r)*r,2)-4*imag_orig[1]*r*pow(a*a+(-2+r)*r,2)+imag_orig_dr[4]*pow(a*a+(-2+r)*r,3)-8*imag_orig[3]*a*(-1+r)*(a*a+r*r)+2*imag_orig_dr[3]*a*(a*a+(-2+r)*r)*(a*a+r*r)+4*imag_orig[1]*(-1+r)*(a*a+(-2+r)*r)*(a*a+r*r)+4*imag_orig[0]*r*(a*a+(-2+r)*r)*(a*a+r*r)-2*imag_orig_dr[1]*pow(a*a+(-2+r)*r,2)*(a*a+r*r)-4*imag_orig[0]*(-1+r)*pow(a*a+r*r,2)+imag_orig_dr[0]*(a*a+(-2+r)*r)*pow(a*a+r*r,2))*sinmdphi)))/(pow(a*a+(-2+r)*r,3)*sinth*sinth);
imag_conv_dr[4]=(factor*(cosmdphi*(a*a+(-2+r)*r)*(imag_orig[9]*a*a-2*imag_orig[6]*a*(a*a+(-2+r)*r)+imag_orig[4]*pow(a*a+(-2+r)*r,2)+2*imag_orig[3]*a*(a*a+r*r)-2*imag_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+imag_orig[0]*pow(a*a+r*r,2))-(a*a+(-2+r)*r)*(real_orig[9]*a*a-2*real_orig[6]*a*(a*a+(-2+r)*r)+real_orig[4]*pow(a*a+(-2+r)*r,2)+2*real_orig[3]*a*(a*a+r*r)-2*real_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+real_orig[0]*pow(a*a+r*r,2))*sinmdphi-r*(mdphi_dr*cosmdphi*(a*a+(-2+r)*r)*(real_orig[9]*a*a-2*real_orig[6]*a*(a*a+(-2+r)*r)+real_orig[4]*pow(a*a+(-2+r)*r,2)+2*real_orig[3]*a*(a*a+r*r)-2*real_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+real_orig[0]*pow(a*a+r*r,2))-cosmdphi*(-4*imag_orig[9]*a*a*(-1+r)+imag_orig_dr[9]*a*a*(a*a+(-2+r)*r)+4*imag_orig[6]*a*(-1+r)*(a*a+(-2+r)*r)+4*imag_orig[3]*a*r*(a*a+(-2+r)*r)-2*imag_orig_dr[6]*a*pow(a*a+(-2+r)*r,2)-4*imag_orig[1]*r*pow(a*a+(-2+r)*r,2)+imag_orig_dr[4]*pow(a*a+(-2+r)*r,3)-8*imag_orig[3]*a*(-1+r)*(a*a+r*r)+2*imag_orig_dr[3]*a*(a*a+(-2+r)*r)*(a*a+r*r)+4*imag_orig[1]*(-1+r)*(a*a+(-2+r)*r)*(a*a+r*r)+4*imag_orig[0]*r*(a*a+(-2+r)*r)*(a*a+r*r)-2*imag_orig_dr[1]*pow(a*a+(-2+r)*r,2)*(a*a+r*r)-4*imag_orig[0]*(-1+r)*pow(a*a+r*r,2)+imag_orig_dr[0]*(a*a+(-2+r)*r)*pow(a*a+r*r,2))+mdphi_dr*(a*a+(-2+r)*r)*(imag_orig[9]*a*a-2*imag_orig[6]*a*(a*a+(-2+r)*r)+imag_orig[4]*pow(a*a+(-2+r)*r,2)+2*imag_orig[3]*a*(a*a+r*r)-2*imag_orig[1]*(a*a+(-2+r)*r)*(a*a+r*r)+imag_orig[0]*pow(a*a+r*r,2))*sinmdphi+(-4*real_orig[9]*a*a*(-1+r)+real_orig_dr[9]*a*a*(a*a+(-2+r)*r)+4*real_orig[6]*a*(-1+r)*(a*a+(-2+r)*r)+4*real_orig[3]*a*r*(a*a+(-2+r)*r)-2*real_orig_dr[6]*a*pow(a*a+(-2+r)*r,2)-4*real_orig[1]*r*pow(a*a+(-2+r)*r,2)+real_orig_dr[4]*pow(a*a+(-2+r)*r,3)-8*real_orig[3]*a*(-1+r)*(a*a+r*r)+2*real_orig_dr[3]*a*(a*a+(-2+r)*r)*(a*a+r*r)+4*real_orig[1]*(-1+r)*(a*a+(-2+r)*r)*(a*a+r*r)+4*real_orig[0]*r*(a*a+(-2+r)*r)*(a*a+r*r)-2*real_orig_dr[1]*pow(a*a+(-2+r)*r,2)*(a*a+r*r)-4*real_orig[0]*(-1+r)*pow(a*a+r*r,2)+real_orig_dr[0]*(a*a+(-2+r)*r)*pow(a*a+r*r,2))*sinmdphi)))/(pow(a*a+(-2+r)*r,3)*sinth*sinth);
real_conv_dr[5]=(factor*(mdphi_dr*cosmdphi*(a*a+(-2+r)*r)*(imag_orig[8]*a-imag_orig[5]*(a*a+(-2+r)*r)+imag_orig[2]*(a*a+r*r))+cosmdphi*(-2*real_orig[8]*a*(-1+r)+real_orig_dr[8]*a*(a*a+(-2+r)*r)+2*real_orig[2]*r*(a*a+(-2+r)*r)-real_orig_dr[5]*pow(a*a+(-2+r)*r,2)-2*real_orig[2]*(-1+r)*(a*a+r*r)+real_orig_dr[2]*(a*a+(-2+r)*r)*(a*a+r*r))-mdphi_dr*(a*a+(-2+r)*r)*(real_orig[8]*a-real_orig[5]*(a*a+(-2+r)*r)+real_orig[2]*(a*a+r*r))*sinmdphi+(-2*imag_orig[8]*a*(-1+r)+imag_orig_dr[8]*a*(a*a+(-2+r)*r)+2*imag_orig[2]*r*(a*a+(-2+r)*r)-imag_orig_dr[5]*pow(a*a+(-2+r)*r,2)-2*imag_orig[2]*(-1+r)*(a*a+r*r)+imag_orig_dr[2]*(a*a+(-2+r)*r)*(a*a+r*r))*sinmdphi))/(pow(a*a+(-2+r)*r,2)*sinth);
imag_conv_dr[5]=-((factor*(mdphi_dr*cosmdphi*(a*a+(-2+r)*r)*(real_orig[8]*a-real_orig[5]*(a*a+(-2+r)*r)+real_orig[2]*(a*a+r*r))-cosmdphi*(-2*imag_orig[8]*a*(-1+r)+imag_orig_dr[8]*a*(a*a+(-2+r)*r)+2*imag_orig[2]*r*(a*a+(-2+r)*r)-imag_orig_dr[5]*pow(a*a+(-2+r)*r,2)-2*imag_orig[2]*(-1+r)*(a*a+r*r)+imag_orig_dr[2]*(a*a+(-2+r)*r)*(a*a+r*r))+mdphi_dr*(a*a+(-2+r)*r)*(imag_orig[8]*a-imag_orig[5]*(a*a+(-2+r)*r)+imag_orig[2]*(a*a+r*r))*sinmdphi+(-2*real_orig[8]*a*(-1+r)+real_orig_dr[8]*a*(a*a+(-2+r)*r)+2*real_orig[2]*r*(a*a+(-2+r)*r)-real_orig_dr[5]*pow(a*a+(-2+r)*r,2)-2*real_orig[2]*(-1+r)*(a*a+r*r)+real_orig_dr[2]*(a*a+(-2+r)*r)*(a*a+r*r))*sinmdphi))/(pow(a*a+(-2+r)*r,2)*sinth));
real_conv_dr[6]=-((factor*(mdphi_dr*cosmdphi*(a*a+(-2+r)*r)*(imag_orig[9]*a-imag_orig[6]*(a*a+(-2+r)*r)+imag_orig[3]*(a*a+r*r))+cosmdphi*(-2*real_orig[9]*a*(-1+r)+real_orig_dr[9]*a*(a*a+(-2+r)*r)+2*real_orig[3]*r*(a*a+(-2+r)*r)-real_orig_dr[6]*pow(a*a+(-2+r)*r,2)-2*real_orig[3]*(-1+r)*(a*a+r*r)+real_orig_dr[3]*(a*a+(-2+r)*r)*(a*a+r*r))-mdphi_dr*(a*a+(-2+r)*r)*(real_orig[9]*a-real_orig[6]*(a*a+(-2+r)*r)+real_orig[3]*(a*a+r*r))*sinmdphi+(-2*imag_orig[9]*a*(-1+r)+imag_orig_dr[9]*a*(a*a+(-2+r)*r)+2*imag_orig[3]*r*(a*a+(-2+r)*r)-imag_orig_dr[6]*pow(a*a+(-2+r)*r,2)-2*imag_orig[3]*(-1+r)*(a*a+r*r)+imag_orig_dr[3]*(a*a+(-2+r)*r)*(a*a+r*r))*sinmdphi))/(pow(a*a+(-2+r)*r,2)*sinth*sinth));
imag_conv_dr[6]=(factor*(mdphi_dr*cosmdphi*(a*a+(-2+r)*r)*(real_orig[9]*a-real_orig[6]*(a*a+(-2+r)*r)+real_orig[3]*(a*a+r*r))-cosmdphi*(-2*imag_orig[9]*a*(-1+r)+imag_orig_dr[9]*a*(a*a+(-2+r)*r)+2*imag_orig[3]*r*(a*a+(-2+r)*r)-imag_orig_dr[6]*pow(a*a+(-2+r)*r,2)-2*imag_orig[3]*(-1+r)*(a*a+r*r)+imag_orig_dr[3]*(a*a+(-2+r)*r)*(a*a+r*r))+mdphi_dr*(a*a+(-2+r)*r)*(imag_orig[9]*a-imag_orig[6]*(a*a+(-2+r)*r)+imag_orig[3]*(a*a+r*r))*sinmdphi+(-2*real_orig[9]*a*(-1+r)+real_orig_dr[9]*a*(a*a+(-2+r)*r)+2*real_orig[3]*r*(a*a+(-2+r)*r)-real_orig_dr[6]*pow(a*a+(-2+r)*r,2)-2*real_orig[3]*(-1+r)*(a*a+r*r)+real_orig_dr[3]*(a*a+(-2+r)*r)*(a*a+r*r))*sinmdphi))/(pow(a*a+(-2+r)*r,2)*sinth*sinth);
